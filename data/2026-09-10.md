...
Matched keywords: robot, locomotion, quadruped, legged robot
...
Matched keywords: robotics, robot, robot learning, reinforcement learning
...
Matched keywords: robot, robot learning, quadruped, legged robot, reinforcement learning
...
Matched keywords: robot, robotic manipulation, manipulation, world model, tactile
...
Matched keywords: robot, imitation learning, behavior cloning, diffusion policy, visuomotor
...
Matched keywords: robot, multimodal, motion planning
...
Matched keywords: robot, robotic manipulation, manipulation, vla, vlm
...
Matched keywords: manipulation, humanoid, sim-to-real
...
Matched keywords: robot, robotic manipulation, manipulation, vla, reinforcement learning, policy learning, world model
...
Matched keywords: robot, robot learning, dexterous, dexterity, reinforcement learning
...
### [27] [Future-Aware Flow Planning for Safe UAV Target Following](https://arxiv.org/abs/2609.10166)
...
### [28] [CougarTail & CUB: A General-Purpose Mast and Central Utility Board for Cylindrical Underwater Enclosures](https://arxiv.org/abs/2609.10230)
...
### [29] [Multi-Robot Scanner for Automated Full-Body Dermoscopic Imaging](https://arxiv.org/abs/2609.10169)
...
Matched keywords: embodied, embodied ai, robot, robotic manipulation, manipulation, vision-language-action, bimanual
...
Matched keywords: embodied, robot, manipulation, vla, vlm, teleoperation
...
### [43] [DCReg: Decoupled Characterization for Efficient Degenerate LiDAR Registration](https://arxiv.org/abs/2509.06285)
...
Matched keywords: embodied, embodied intelligence, robotics, robot, foundation model
...
### [45] [An Autonomous GeoAI Agent for Arctic Eco-Navigation](https://arxiv.org/abs/2609.09374)
...
### [46] [Decision-Focused Active Learning for Scale-Aware Critical-Materials Recovery](https://arxiv.org/abs/2609.09413)
...
### [47] [Valerant: An Automatic Navigable Game Map Generator via Action-Conditioned World Model Exploration](https://arxiv.org/abs/2609.09418)
...
Matched keywords: embodied, embodied ai, robotics, robot, world model
...
### [48] [CityPlanner: A Sandbox Agent for Executable Urban Planning](https://arxiv.org/abs/2609.09578)
...
### [49] [Seven Sources of Physical AI Capability Formation](https://arxiv.org/abs/2609.09627)
*Gang Chen*
...
### [52] [Time-Frequency Geometric Cross-Attention for Chunked Vision-Language-Action Models](https://arxiv.org/abs/2609.09925)
...
### [54] [Beyond Surface Imitation: Contrastive Modeling for Reasoning Path Alignment in Multimodal In-Context Learning](https://arxiv.org/abs/2609.10177)
...
### [58] [ConvMem: Convolutional Memory for Long-Context Reasoning](https://arxiv.org/abs/2609.10441)
...
### [62] [Uncertainty-Aware Sea-Ice Type Mapping with Multiple Ice Charts](https://arxiv.org/abs/2609.09451)
...
### [63] [Unthrottling the Tanh Jacobian in SAC: A Negative Result on Bang-Bang Control and MetaDrive](https://arxiv.org/abs/2609.09478)
*Faiq Shamass*
...
### [64] [Cascading Gradient Inversion via LT-Code Inspired Peeling in Federated Learning](https://arxiv.org/abs/2609.09659)
...
### [66] [EEGBind: Detecting Source-Level Interictal Epileptiform Discharges via EEG-Centric Multimodal Binding](https://arxiv.org/abs/2609.09728)
...
### [67] [BRACE: Anchored Bellman-Residual Correction for Stale Critics in Asynchronous RL](https://arxiv.org/abs/2609.09783)
...
### [69] [Hierarchical and Permutation-Invariant Feature Transformation Learning via Policy-Guided Embedding Search](https://arxiv.org/abs/2609.10225)
...
### [70] [A Later Test Set Is Not a New Domain: Pretraining Familiarity Survives a Contamination-Free Hold-Out](https://arxiv.org/abs/2609.10357)
...
### [71] [OmniMed-FL: A Robust Multimodal Federated Learning Framework for Clinical Diagnosis](https://arxiv.org/abs/2609.10364)
...
### [73] [Evidence-Order Calibration for Selective Visual Reasoning under Progressive Loss of Question-Critical Evidence](https://arxiv.org/abs/2609.09184)
...
### [74] [M2LG-DG: A Multi-modal Local-Global Domain Generalization Framework for Cross-site Major Depressive Disorder Classification](https://arxiv.org/abs/2609.09186)
...
### [75] [AgenticGen: Reward-Guided Agentic Video Generation for Advertising](https://arxiv.org/abs/2609.09187)
...
### [76] [MLLMs Hallucinate when Information Distribution Drifts in Synergy Heads](https://arxiv.org/abs/2609.09206)
...
### [77] [Video-MOPD: Multi-Teacher On-Policy Distillation for Video Understanding](https://arxiv.org/abs/2609.09300)
...
### [78] [The Living Library: Transforming Archival Collections into Conversational Knowledge Systems -- Lessons from the Theodore Roosevelt Presidential Library](https://arxiv.org/abs/2609.09368)
...
### [80] [Vision-language models know more about agriculture than they show and rubric-grounded verifications close the gap](https://arxiv.org/abs/2609.09417)
...
### [81] [LeCor: Learning to Be Corrected by Meta-Learned Test-Time Training for Interactive 3D Lung-Tumour Segmentation](https://arxiv.org/abs/2609.09477)
...
### [82] [Infra-Bench CLS: A Global, Open-Source Benchmark for Critical Infrastructure Classification with Earth Observation Foundation Models](https://arxiv.org/abs/2609.09482)
...
### [83] [MotionBlind: Probing the Illusion of Motion Understanding in Video-LLMs](https://arxiv.org/abs/2609.09528)
...
### [84] [LogiScope-VQA: Benchmarking Vision-Language Models for Logistics Hazard Identification in Industrial Scenarios](https://arxiv.org/abs/2609.09790)
...
### [85] [CLFTv2: Efficient Camera-LiDAR Fusion for Semantic Segmentation via Hierarchical Feature Pyramids](https://arxiv.org/abs/2609.09881)
...
### [86] [Multimodal Emotion Recognition in Conversations via Class-Wise Adaptive Modality Fusion and Affective Geometry](https://arxiv.org/abs/2609.09924)
...
### [87] [From Few-Shot Segmentation to Clinician-in-the-Loop Medical Image Analysis](https://arxiv.org/abs/2609.10001)
*Yazhou Zhu*
...
### [90] [PACE: Perceived-Latency-Aware Cascading Service Routing and Filler Control for QoE-Efficient Retrieval-Augmented Dialogue Serving](https://arxiv.org/abs/2609.10372)
...
### [91] [Isotropic Embedding Perturbations for Robust Vision Language Encoders](https://arxiv.org/abs/2609.10292)
...
### [92] [Geometry Without Coordinates: LiDAR Diffusion as a 3D Feature Bridge](https://arxiv.org/abs/2609.10322)
...
### [93] [Learning to Adapt and Calibrate: Score Distribution Alignment for Few-Shot Uncertainty Prediction in Medical VLMs](https://arxiv.org/abs/2609.10333)
...
### [94] [Beyond One-Size-Fits-All: Sample-Adaptive Strategy Routing for Vision Token Pruning in MLLMs](https://arxiv.org/abs/2609.10346)
...
### [95] [BrainTaskonomy: Learning How to Pretrain and What to Transfer in fMRI Foundation Models](https://arxiv.org/abs/2609.10518)
...
### [96] [Programmable World Model](https://arxiv.org/abs/2609.10540)
...
### [97] [Edu-QuRating: Multi-Dimensional Educational Data Curation with Distilled Pairwise Judgements](https://arxiv.org/abs/2609.09425)
...
### [100] [SocialRL: Refining LLMs' Social Intelligence through Multi-turn Reinforcement Learning and Reward Design](https://arxiv.org/abs/2609.09764)
...
### [101] [$S^3$-Bench: Evaluating Speech Interaction Models as Scientific Voice Assistants](https://arxiv.org/abs/2609.09852)
...
### [102] [VLX-VR: An Agentic-Aware Video Reasoning Model](https://arxiv.org/abs/2609.09985)
...
### [103] [Data-Centric Post-Training for Financial Reasoning: Mining, Distillation, and Verifiable Learning](https://arxiv.org/abs/2609.10113)
...
### [104] [ProbPlug: A Plugin Uncertainty Network for Reliable Confidence in LLM Binary Classification](https://arxiv.org/abs/2609.10122)
...
### [105] [Two-Token Features and Small-Large Ensembles for VLM Hallucination Detection](https://arxiv.org/abs/2609.10244)
*Eli Schwartz*
...
### [106] [On-Policy Distillation for Vision-Language Model Adaptation, an Effective Paradigm on Low-Quality Multimodal Data](https://arxiv.org/abs/2609.10321)
...
### [107] [Can Foundation Models Moderate Online Content? Evaluating Instruction- vs. Example-Driven Policy Operationalization](https://arxiv.org/abs/2609.10410)
...
### [108] [Do speech foundation models really learn words?](https://arxiv.org/abs/2609.10434)
...
### [109] [Building Multilingual Bridges: Data Mixing as the Pillar of Generalization for In-Language Reasoning](https://arxiv.org/abs/2609.10445)
...
### [110] [From Learning to Control: Data-Driven Multi-Agent Reinforcement Learning for Multivariable Control in a Microalgae Bioprocess](https://arxiv.org/abs/2609.09313)
...
### [111] [Networked Admissibility-Preserving Control for Directed Safe Coordination](https://arxiv.org/abs/2609.09384)
...
### [112] [IMU-Centric Moving Horizon Estimation for Lateral Dynamics Estimation Across Vehicles and Grip Conditions](https://arxiv.org/abs/2609.10202)
