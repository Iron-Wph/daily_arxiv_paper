...
Matched keywords: robot, robotic manipulation, manipulation, vla, policy learning, world model, contact-rich, teleoperation
...
Matched keywords: embodied, robotics, robot, tactile
...
Matched keywords: embodied, robot, navigation, humanoid, quadruped, vision-language-action, vla, multimodal, foundation model
...
Matched keywords: robot, manipulation, locomotion, humanoid, imitation learning, policy learning, visuomotor, contact-rich, teleoperation
...
Matched keywords: robot, robot learning, robotic manipulation, manipulation, vision-language-action, vision language action, vla
...
### [14] [Natural Locomotion: Principle and Method](https://arxiv.org/abs/2605.28254)
...
### [15] [Turning Video Models into Generalist Robot Policies](https://arxiv.org/abs/2605.27817)
...
Matched keywords: embodied, robotics, robot, manipulation, dexterous, world model, foundation model, robot foundation model
...
### [16] [Safety-Critical Adaptive Impedance Control via Nonsmooth Control Barrier Functions under State and Input Constraints](https://arxiv.org/abs/2605.28367)
...
### [17] [Tabero: Learning Gentle Manipulation with Closed-Loop Force Feedback from Vision, Touch, and Language](https://arxiv.org/abs/2605.27886)
...
Matched keywords: robot, robotic manipulation, manipulation, vision-language-action, vla, multimodal, language-conditioned, tactile
...
### [18] [SARAD: LLM-Based Safety-Aware Hybrid Reinforcement Learning with Collision Prediction for Autonomous Driving](https://arxiv.org/abs/2605.28583)
...
### [19] [S-Cheetah: A Novel Quadrupedal Robot with a 3-DOF Active Spine Learning Agile Locomotion](https://arxiv.org/abs/2605.27909)
*Zimu Li,Weibang Bai*
...
Matched keywords: robotics, robot, dexterous, locomotion, quadruped, reinforcement learning
...
### [20] [Integrated Exploration-Aware UAV Route Optimization and Path Planning](https://arxiv.org/abs/2605.28654)
...
### [21] [A Surveillance Evasion Game with Continuous Sensor Redeployment via Bilevel Optimization](https://arxiv.org/abs/2605.27917)
...
### [22] [Frequency-Guided Action Diffusion via Sub-Frequency Manifold Traversal](https://arxiv.org/abs/2605.27919)
*Junlin Wang*
...
Matched keywords: robot, robotic manipulation, manipulation, behavior cloning, visuomotor
...
### [23] [SANTS: A State-Adaptive Scheduler for World Action Models](https://arxiv.org/abs/2605.27947)
...
### [24] [VLM-Based Advanced Rider Assistance System for Motorcycle Safety](https://arxiv.org/abs/2605.27948)
...
### [25] [Simultaneous Contact Selection and Planning for Contact-Rich Manipulation with Cascaded Optimization](https://arxiv.org/abs/2605.27972)
...
### [26] [How Should We Teach Robots? A Comparison of Kinesthetic, Joystick, and Gesture-Based Teaching](https://arxiv.org/abs/2605.28033)
...
Matched keywords: robot, manipulation, contact-rich, teleoperation
...
### [27] [SAFEVPR: Patch-Based Conformal Verification for Safe Cross-Condition Sequence Visual Place Recognition](https://arxiv.org/abs/2605.28048)
...
### [28] [Whose Is This?: Context-Aware Object Ownership Inference with Uncertainty-Guided Questioning](https://arxiv.org/abs/2605.28087)
...
### [29] [An Operator-Based Approach to STL](https://arxiv.org/abs/2605.28092)
...
### [30] [ICAN-Deploy: Identity-Stable Canary Deployment for Safety-Critical Embodied Agents](https://arxiv.org/abs/2605.28097)
...
### [31] [STR Robot: Design of an Autonomous Mobile Robot from Simulation to Reality](https://arxiv.org/abs/2605.28110)
...
### [33] [Visualizing Latent Phase Structures in Locomotion Policies: A Multi-Environment Study with Temporal Feature Extension](https://arxiv.org/abs/2605.28186)
...
### [34] [Natural Functional Gradients for Smooth Trajectory Optimization](https://arxiv.org/abs/2605.28202)
...
### [35] [ProgVLA: Progress-Aware Robot Manipulation Skill Learning](https://arxiv.org/abs/2605.28231)
...
Matched keywords: robot, manipulation, vision-language-action, vla, imitation learning, reinforcement learning
...
### [36] [POINav: Benchmarking and Enhancing Final-Meters Arrival in Real-World Vision-Language Navigation](https://arxiv.org/abs/2605.28237)
...
### [37] [IMU Propagation as Preintegration](https://arxiv.org/abs/2605.28279)
*Jianzhu Huai*
...
### [38] [EventShiftFlow: Towards Hardware-efficient FPGA-based Flow Estimation](https://arxiv.org/abs/2605.28312)
...
### [39] [Identifying Explicit Parsimonious Piece-wise Polynomial Relationships in Industrial time-series: Application to manipulator robots](https://arxiv.org/abs/2605.28320)
...
### [40] [Chance-Constrained MPPI under State and Dynamic Object Prediction Uncertainty and the Evaluation of Collision Risk Calibration](https://arxiv.org/abs/2605.28330)
...
### [41] [Magnet-Based Soft Robotic Skin Using a 3D-Printed Multi-Lattice Structure and CNN-Based Tactile Super-Resolution](https://arxiv.org/abs/2605.28352)
...
### [42] [Accelerating Robot Path Planning via Connectivity-Preserving Region Proposal Network](https://arxiv.org/abs/2605.28362)
...
### [43] [Tactile-Proprioceptive Sensor Fusion for Contact Wrench Estimation in Whole-Body Physical Human-Robot Interaction](https://arxiv.org/abs/2605.28412)
...
### [44] [Self-Supervised Online Robot-Agnostic Traversability Estimation for Open-World Environments](https://arxiv.org/abs/2605.28442)
...
Matched keywords: robot, locomotion, navigation, multimodal
...
### [45] [A Digital Twin Framework for Virtual Visuo-Haptic Teleoperation of Complex-Shaped Optical Microrobots](https://arxiv.org/abs/2605.28448)
...
Matched keywords: robot, manipulation, teleoperation, bimanual
...
### [46] [Learning a Kinodynamic Trajectory Manifold for Impact-Aware Compliant Catching of Fast-Moving Objects](https://arxiv.org/abs/2605.28462)
...
### [47] [EIT-Pneumatic Hybrid Robotic Skin for Practical and Accurate Force Map Reconstruction](https://arxiv.org/abs/2605.28468)
...
Matched keywords: robotics, robot, humanoid, tactile
...
### [48] [Mag-VLA: Vision-Language-Action Model for Bimanual Magnetically Actuated Microrobot Manipulation](https://arxiv.org/abs/2605.28486)
...
Matched keywords: robot, manipulation, dexterous, vision-language-action, vla, bimanual
...
### [49] [What Frozen VLAs Already Know About Success: A Probing Study of Value-Like Structure in Foundation Robot Policies](https://arxiv.org/abs/2605.28527)
...
### [50] [SPRINT: Efficient Spectral Priors for Humanoid Athletic Sprints](https://arxiv.org/abs/2605.28549)
...
Matched keywords: locomotion, humanoid, sim-to-real
...
### [51] [PrimitiveVLA: Learning Reusable Motion Primitives for Efficient and Generalizable Robotic Manipulation](https://arxiv.org/abs/2605.28634)
...
Matched keywords: robot, robotic manipulation, manipulation, vision-language-action, vla, vlm, multimodal
...
Matched keywords: robot, manipulation, vla, diffusion policy, bimanual
...
Matched keywords: robot, imitation learning, diffusion policy
...
Matched keywords: manipulation, dexterous, reinforcement learning, sim-to-real, tactile, contact-rich
...
### [55] [Soro: A Lightweight Foundation Model and Chatbot for Tajik](https://arxiv.org/abs/2605.27379)
...
### [56] [Cyberbullying Governance on Social Media: A Unified Framework from Content Identification to Intervention](https://arxiv.org/abs/2605.27584)
...
### [58] [PEAM: Parametric Embodied Agent Memory through Contrastive Internalization of Experience in Minecraft](https://arxiv.org/abs/2605.27762)
...
### [59] [EgoBench: An Interactive Egocentric Multimodal Benchmark for Tool-Using Agents](https://arxiv.org/abs/2605.27820)
...
### [60] [EAPO: Entropy-Driven Adaptive Positive-Negative Sample Weighting for Policy Optimization in Open-Ended QA](https://arxiv.org/abs/2605.27846)
...
### [61] [C-MIG: Multi-view Information Gain-based Retrieval-Augmented Generation for Clinical Diagnosis Reasoning](https://arxiv.org/abs/2605.27860)
...
### [62] [Towards Faithful Agentic XAI: A Verification Method and an Open-World Benchmark for Better Model Faithfulness](https://arxiv.org/abs/2605.27879)
...
### [63] [SKILLC: Learning Autonomous Skill Internalization in LLM Agents via Contrastive Credit Assignment](https://arxiv.org/abs/2605.27899)
...
### [64] [Reasoning Matters: Mitigate Hallucination in Multimodal Large Reasoning Models via Reasoning-Conditioned Preference Optimization](https://arxiv.org/abs/2605.27906)
...
### [68] [ZipRL: Adaptive Multi-Turn Context Compression with Hindsight Response Replay](https://arxiv.org/abs/2605.28069)
...
### [69] [Bridging the Detection-to-Abstention Gap in Reasoning Models under Insufficient Information](https://arxiv.org/abs/2605.28070)
...
### [70] [MACReD: A Multi-Agent Collaborative Reasoning Framework for Reaction Diagram Parsing](https://arxiv.org/abs/2605.28077)
...
### [73] [Do Clinical Models Change Treatment Decisions?](https://arxiv.org/abs/2605.28129)
...
### [74] [Deconstructing Spatial Complexity: Hierarchical Decomposition for LLM Spatial Reasoning](https://arxiv.org/abs/2605.28144)
...
Matched keywords: embodied, embodied intelligence, navigation, reinforcement learning, path planning
...
### [75] [OccuReward: LLM-Guided Occupant-Centric Reward Shaping for Demographic Equity in Grid-Interactive Buildings](https://arxiv.org/abs/2605.28168)
...
### [76] [Explaining is Harder Than Predicting Alone: Evaluating Concept-based Explanations of MLLMs as ICL Visual Classifiers](https://arxiv.org/abs/2605.28215)
...
### [77] [PIRS: Physics-Informed Reward Shaping for SAC-Based Building Energy Management](https://arxiv.org/abs/2605.28232)
*Shadmehr Zaregarizi,Khashayar Yavari*
...
### [78] [Global Policy-Space Response Oracles for Two-Player Zero-Sum Games](https://arxiv.org/abs/2605.28273)
...
### [79] [Do LLMs Build World Models From Text? A Multilingual Diagnostic of Spatial Reasoning](https://arxiv.org/abs/2605.28277)
...
### [80] [Where Rollouts Begin: Low-Load, High-Leverage First-Token Diversification for RLVR](https://arxiv.org/abs/2605.28295)
*Soeun Kim,Albert No*
...
### [81] [Plan Before Search: Search Agents Need Plan](https://arxiv.org/abs/2605.28354)
...
### [82] [CyberJurors: A Multi-Agent Simulation Task for E-Commerce Disputes Verdict](https://arxiv.org/abs/2605.28369)
...
### [83] [Mechanistically Interpreting the Role of Sample Difficulty in RLVR for LLMs](https://arxiv.org/abs/2605.28388)
...
### [84] [Efficient Post-training of LLMs for Code Generation With Offline Reinforcement Learning](https://arxiv.org/abs/2605.28409)
...
### [85] [DenoiseRL: Bootstrapping Reasoning Models to Recover from Noisy Prefixes](https://arxiv.org/abs/2605.28421)
...
### [86] [GONDOR to the Rescue: Satisficing Planning with Low Memory](https://arxiv.org/abs/2605.28454)
...
### [87] [GS-FUSE: Granger-Supervised Gated Fusion and Multi-Granularity Alignment for Event-Driven Financial Forecasting](https://arxiv.org/abs/2605.28520)
...
### [88] [A Conflict-Aware Penalty and Statistical Loss Framework for Balancing Modalities and Enhancing Stability in Multimodal Sentiment Analysis](https://arxiv.org/abs/2605.28575)
...
### [89] [MUSE: Benchmarking Manufacturable, Functional, and Assemblable Text-to-CAD Generation](https://arxiv.org/abs/2605.28579)
...
### [90] [Adaptive Multimodal Agents-Based Framework for Automatic Workflow Execution](https://arxiv.org/abs/2605.28607)
...
### [91] [Bandwidth-Efficient and Privacy-Preserving Edge-Cloud Many-to-Many Speech Translation](https://arxiv.org/abs/2605.28642)
...
### [92] [DREAM-R: Multimodal Speculative Reasoning with RL-Based Refined Drafting, Precise Verification, and Fully Parallel Execution](https://arxiv.org/abs/2605.28678)
...
### [93] [VeriTrip: A Verifiable Benchmark for Travel Planning Agents over Unstructured Web Corpora](https://arxiv.org/abs/2605.28683)
...
### [94] [AlphaTransit: Learning to Design City-scale Transit Routes](https://arxiv.org/abs/2605.28730)
...
### [95] [Utility-Aware Multimodal Contrastive Learning for Product Image Generation](https://arxiv.org/abs/2605.28733)
...
### [96] [Personalized Observation Normalization for Federated Reinforcement Learning in Simulation Environments with Heterogeneity](https://arxiv.org/abs/2605.27385)
...
### [97] [Tackling Multimodal Learning Challenges with Mixture-of-Expert: A Survey](https://arxiv.org/abs/2605.27431)
...
### [98] [Information-theoretic Multimodal Representation Learning for Electrocardiogram Signals](https://arxiv.org/abs/2605.27583)
...
### [99] [Transferable Reinforcement Learning via Probabilistic Latent Embeddings and Dynamic Policy Adaptation for Sim-to-Real Deployment](https://arxiv.org/abs/2605.27659)
...
### [100] [Heterogeneous Parallelism for Multimodal Large Language Model Training](https://arxiv.org/abs/2605.27678)
...
### [101] [Bayesian Deployment Approval for Learned Landing Controllers under Finite Rollout Validation](https://arxiv.org/abs/2605.27720)
*Fei Jiang,Lei Yang*
...
### [102] [Explicit Critic Guidance for Aligning Diffusion Models](https://arxiv.org/abs/2605.27736)
...
### [103] [Restoring the Sweet Spot: Pass-Rate Weighted Self-Distillation for LLM Reasoning](https://arxiv.org/abs/2605.27765)
...
### [104] [Reward Transfer from Inverse Reinforcement Learning: A Coupled Minimax Approach](https://arxiv.org/abs/2605.27834)
...
### [105] [SPAR: Support-Preserving Action Rectification](https://arxiv.org/abs/2605.27877)
...
Matched keywords: behavior cloning
...
### [106] [Teacher-Student Representational Alignment for Reinforcement Learning-Driven Imitation Learning](https://arxiv.org/abs/2605.28372)
...
Matched keywords: robotics, robot, imitation learning, reinforcement learning
...
### [107] [Cyclical Entropy Eruption: Entropy Dynamics in Agent Reinforcement Learning](https://arxiv.org/abs/2605.27954)
...
### [108] [Continual Learning in Modern Hopfield Networks with an Application to Diffusion Models](https://arxiv.org/abs/2605.27975)
...
### [109] [Long Live The Balance: Information Bottleneck Driven Tree-based Policy Optimization](https://arxiv.org/abs/2605.28109)
...
### [110] [Chreode: A Cell World Model for One-Step Temporal Dynamics and Perturbation Prediction](https://arxiv.org/abs/2605.28111)
...
### [111] [Adaptive Coarse-to-Fine Subgoal Refinement for Long-Horizon Offline Goal-Conditioned Reinforcement Learning](https://arxiv.org/abs/2605.28127)
...
### [113] [Joint Training of Multi-Token Prediction in Reinforcement Learning via Optimal Coefficient Calibration](https://arxiv.org/abs/2605.28184)
...
### [114] [Hierarchical Synthetic Tabular Data Generation: A Hybrid Top-Down and Bottom-Up Framework](https://arxiv.org/abs/2605.28198)
...
### [115] [PhAME: Phenotype-Aware Molecular Editing via Latent Diffusion](https://arxiv.org/abs/2605.28226)
...
### [116] [IRDS: Interpretable RLVR Data Selection via Verifier-Coupled Sparse Autoencoder Coverage](https://arxiv.org/abs/2605.28247)
...
### [117] [Commit to the Bit: Reactive Reinforcement Learning Done Right](https://arxiv.org/abs/2605.28276)
...
### [118] [AtomComposer: Discovering Chemical Space from First Principles with Reinforcement Learning](https://arxiv.org/abs/2605.28287)
...
### [119] [ProRL: Effective Reinforcement Learning for Proactive Recommendation via Rectified Policy Gradient Estimation](https://arxiv.org/abs/2605.28293)
...
### [120] [Hybrid Neural World Models](https://arxiv.org/abs/2605.28317)
...
### [121] [LEIA: Learned Environment for Interactive Architected Materials](https://arxiv.org/abs/2605.28368)
...
### [123] [Revisiting Metafeatures to Explain Model Differences on Tabular Data](https://arxiv.org/abs/2605.28418)
...
### [124] [High Performance, Low Reliability: Uncertainty Benchmarking for Tabular Foundation Models](https://arxiv.org/abs/2605.28554)
...
### [125] [A Multi-dimensional Framework for Evaluating Generalization in EEG Foundation Models](https://arxiv.org/abs/2605.28563)
...
### [127] [Applications of temporal graph learning for predicting the dynamics of biological systems](https://arxiv.org/abs/2605.28659)
...
### [128] [Optimal Data Acquisition for Reinforcement Learning: A Large Deviations Perspective](https://arxiv.org/abs/2605.28675)
...
### [129] [Affective Music Recommendation: A Rollout-Based World Model for Offline Preference Optimization](https://arxiv.org/abs/2605.28810)
...
### [130] [From Affect to Complex Behavior: Advancing Multimodal Human-Centered AI at the 10th ABAW Workshop & Competition](https://arxiv.org/abs/2605.27451)
...
### [131] [Fine-Tuning Vision-Language Models for Understanding Current Damage and Scoring Priority with Quality Guard Agent](https://arxiv.org/abs/2605.27452)
*Takato Yasuno*
...
### [132] [Beyond Motion Primitives: Behavioral Activity Recognition from Head-Mounted IMU](https://arxiv.org/abs/2605.27464)
...
### [133] [What-If World: A Causal Benchmark for General World Models in Embodied Scenarios](https://arxiv.org/abs/2605.27589)
...
### [134] [ForestHG-Trace: Traceable Long-Horizon Ecological Reasoning over Large-Scale Forest Scenes](https://arxiv.org/abs/2605.27590)
...
### [135] [Hallucination Behavior in Multimodal LLMs Across Agricultural Image Interpretation and Generation Tasks](https://arxiv.org/abs/2605.27595)
...
### [136] [Bounded-Compute Multimodal Regression for Product-Rating Prediction](https://arxiv.org/abs/2605.27737)
...
### [137] [AndroidDaily: A Verifiable Benchmark for Mobile GUI Agents on Real-World Closed-Source Applications](https://arxiv.org/abs/2605.27761)
...
### [138] [Can Segmentation Models Understand the World? Towards Proactive Affordance Reasoning via Visual Chain-of-Thought](https://arxiv.org/abs/2605.27764)
*Yuchen Guo,Junli Gong,Hongmin Cai,Yiu-ming Cheung,Weifeng Su*
...
### [139] [CuriosAI Submission to the CASTLE Challenge at EgoVis 2026](https://arxiv.org/abs/2605.27800)
...
### [140] [SIGMA: Bridging Structural and Distributional Gaps for Vision Foundation Model Adaptation](https://arxiv.org/abs/2605.27893)
...
### [141] [Towards Unified Vision-Language Models with Incomplete Multi-Modal Inputs](https://arxiv.org/abs/2605.27894)
...
### [142] [Decoupled Training with Local Reinforcement Fine-Tuning in Federated Learning](https://arxiv.org/abs/2605.27900)
...
### [143] [OphIn-500K: Curating Web-Scale Visual Instructions for Scaling Ophthalmic Multimodal Large Language Models](https://arxiv.org/abs/2605.27916)
...
### [144] [Rethinking Video-Language Model from the Language Input Perspective](https://arxiv.org/abs/2605.27920)
...
### [145] [SIGMA: Semantic-Difference Instruction-Grounding Mask Annotator for Text-Driven Image Manipulation Localization](https://arxiv.org/abs/2605.27924)
...
### [146] [When Think-with-Image Meets Safety: What Determines Multimodal Jailbreak Robustness?](https://arxiv.org/abs/2605.27932)
...
### [147] [Con-DSO: Learning Short-Horizon Consistency Priors for RGB-D Direct Sparse Odometry](https://arxiv.org/abs/2605.27952)
...
### [148] [ROVER: Routing Object-Centric Visual Evidence for Grounded Multi-Image Reasoning](https://arxiv.org/abs/2605.27959)
...
### [149] [Mags-RL: Wearing Multimodal LLMs a Magnifying Glass via Agentic Reinforcement Learning For Complex Scene Reasoning](https://arxiv.org/abs/2605.27960)
...
### [150] [ABot-OCR Technical Report](https://arxiv.org/abs/2605.27978)
...
### [151] [Beyond Surrogate Gradients: Fully Differentiable Token Pruning for Vision-Language Models](https://arxiv.org/abs/2605.28051)
...
### [152] [CogPortrait: Fine-Grained Eye-Region Control in Portrait Animation via Hierarchical Agent Planning](https://arxiv.org/abs/2605.28056)
...
### [153] [VLA-Hijack: A Transferable Patch Attack against Vision-Language-Action Models via Visual Proprioception Hijacking](https://arxiv.org/abs/2605.28083)
...
### [154] [SAM-Enhanced Segmentation on Road Datasets: Balancing Critical Classes in Autonomous Driving](https://arxiv.org/abs/2605.28136)
...
### [155] [Which Pretraining Paradigm Better Serves Spatial Intelligence? An Empirical Comparison of Vision-Language and Video Generation Models](https://arxiv.org/abs/2605.28132)
...
### [156] [Intra-YOLO: A Small Object Detection Model for Caries and Molar-Incisor Hypomineralization in Intraoral Photography Based on Transfer Learning with Reinforcement Learning](https://arxiv.org/abs/2605.28157)
...
### [157] [MeniOmni: A Structured Multimodal Benchmark for Holistic Meniscus Injury Assessment](https://arxiv.org/abs/2605.28161)
...
### [158] [FLORO: A Multimodal Geospatial Foundation Model for Ecological Remote Sensing Across Sensors and Scales](https://arxiv.org/abs/2605.28174)
...
### [159] [Proprio: Latent Self-Scoring and Inference-Time Refinement for Physically Plausible Video Generation](https://arxiv.org/abs/2605.28230)
...
### [160] [Learning to Label: A Reinforced Self-Evolving Framework for Semi-supervised Referring Expression Segmentation](https://arxiv.org/abs/2605.28239)
...
### [161] [Category-Level 3D Correspondence in Camera Space via Morphable Object Priors](https://arxiv.org/abs/2605.28257)
...
### [162] [Every9D-21M: Large-Scale Real-World 9D Canonicalization of Everyday Objects](https://arxiv.org/abs/2605.28270)
...
### [163] [EchoAvatar: Real-time Generative Avatar Animation from Audio Streams](https://arxiv.org/abs/2605.28272)
...
### [164] [Sketch2Motion: Text-driven 2D Sketch to 3D Animation via Diffusion-guided Skeleton Optimization](https://arxiv.org/abs/2605.28394)
...
### [165] [Adaptive Temporal Gating of Longitudinal Magnetic Resonance Imaging for Alzheimer's Prediction](https://arxiv.org/abs/2605.28397)
...
### [166] [REVEAL: Reference-Grounded Reasoning for Multimodal Manipulation Detection](https://arxiv.org/abs/2605.28459)
...
### [167] [DiscoForcing: A Unified Framework for Real-Time Audio-Driven Character Control with Diffusion Forcing](https://arxiv.org/abs/2605.28491)
...
### [168] [DriveWAM: Video Generative Priors Enable Scalable World-Action Modeling for Autonomous Driving](https://arxiv.org/abs/2605.28544)
...
### [169] [GEM: Generative Supervision Helps Embodied Intelligence](https://arxiv.org/abs/2605.28548)
...
Matched keywords: embodied, embodied intelligence, robotics, robot, vision-language-action, vla, vlm
...
### [170] [Deformable Gaussian Occupancy: Decoupling Rigid and Nonrigid Motion with Factorized Distillation](https://arxiv.org/abs/2605.28587)
...
### [171] [JECA^2: Judgment-Explanation Consistent Adversarial Attack against Forensic Vision-Language Models](https://arxiv.org/abs/2605.28609)
*Jiachen Qian*
...
### [172] [OSP-Next: Efficient High-Quality Video Generation with Sparse Sequence Parallelism, HiF8 Quantization, and Reinforcement Learning](https://arxiv.org/abs/2605.28691)
...
### [173] [Self-Prophetic Decoding to Unlock Visual Search in LVLMs](https://arxiv.org/abs/2605.28741)
...
### [174] [Ω-QVLA: Robust Quantization for Vision-Language-Action Models via Composite Rotation and Per-step Scaling](https://arxiv.org/abs/2605.28803)
...
### [175] [Personal Visual Memory from Explicit and Implicit Evidence](https://arxiv.org/abs/2605.28806)
...
### [176] [Gamma-World: Generative Multi-Agent World Modeling Beyond Two Players](https://arxiv.org/abs/2605.28816)
...
### [177] [From Pixels to Words -- Towards Native One-Vision Models at Scale](https://arxiv.org/abs/2605.28820)
...
### [178] [ICG: Improving Cover Image Generation via MLLM-based Prompting and Personalized Preference Alignment](https://arxiv.org/abs/2605.27374)
...
### [179] [OralAgent: Integrating Reasoning, Tools, and Knowledge for Interactive Dental Image Analysis](https://arxiv.org/abs/2605.27378)
...
### [180] [PAST2HARM: A Simple Adaptive Past Tense Attack for Jailbreaking Multimodal AI](https://arxiv.org/abs/2605.27545)
...
### [181] [Disentangling Language Roles in Multilingual LLM Task Execution](https://arxiv.org/abs/2605.27649)
...
### [182] [ReverseMath: Answer Inversion for Scalable and Verifiable Mathematical Problem Generation](https://arxiv.org/abs/2605.27709)
...
### [183] [Escape the Language Prior: Mitigating Late-Stage Modality Collapse in Audio Reasoning via Modality-Aware Policy Optimization](https://arxiv.org/abs/2605.27741)
...
Matched keywords: multimodal, instruction following, reinforcement learning
...
### [184] [Reading or Guessing? Visual Grounding Failures of Vision-Language Models for OCR in Ancient Greek Editions](https://arxiv.org/abs/2605.27750)
...
### [185] [UniMaia: Steering Chess Policies with Language for Human-like Play](https://arxiv.org/abs/2605.27767)
...
### [186] [Playing with Words, Improving with Rewards: Training Language Models for Creative Association](https://arxiv.org/abs/2605.27832)
...
### [187] [MERIT: Matching Expertise via Rubric-Informed Training for Reviewer Assignment](https://arxiv.org/abs/2605.27865)
...
### [188] [The Fragility of Chain-of-Thought Monitoring Across Typologically Diverse Languages](https://arxiv.org/abs/2605.27901)
...
### [189] [GeneralThinker: Domain-General Reasoning through Likelihood-Guided Answer-Conditioned Optimization](https://arxiv.org/abs/2605.27934)
...
### [190] [Rethinking Visual Neglect: Steering via Context-Preference for MLLM Hallucination Mitigation](https://arxiv.org/abs/2605.27993)
...
### [191] [KSAFE-MM: A Multimodal Safety Benchmark via Localized Contextualization for Korean Cultural Risks](https://arxiv.org/abs/2605.28013)
...
### [192] [Beyond pass@k: Redundancy-Aware RLVR for Multi-Sample Code Generation](https://arxiv.org/abs/2605.28022)
...
### [193] [StoryLens: Preference-Aligned Story Rewriting via Context-Aware Narrative Enrichment](https://arxiv.org/abs/2605.28073)
...
### [194] [When Discourse Pressures Conflict: Information Structure in Vision-Language Model Outputs](https://arxiv.org/abs/2605.28346)
...
### [195] [Skill0.5: Joint Skill Internalization and Utilization for Out-of-Distribution Generalization in Agentic Reinforcement Learning](https://arxiv.org/abs/2605.28424)
...
### [196] [GUI-CIDER: Mid-training GUI Agents via Causal Internalization and Density-aware Exemplar Reselection](https://arxiv.org/abs/2605.28534)
...
### [197] [Soft-SVeRL: Self-Verified Reinforcement Learning with Soft Rewards](https://arxiv.org/abs/2605.28561)
...
### [198] [Mobile-Aptus: Confidence-Driven Proactive and Robust Interaction in MLLM-based Mobile-Using Agents](https://arxiv.org/abs/2605.28629)
...
### [199] [The Abstraction Gap in Vision-Language Causal Reasoning](https://arxiv.org/abs/2605.28779)
...
### [200] [OmniVerifier-M1: Multimodal Meta-Verifier with Explicit Structured Recalibration](https://arxiv.org/abs/2605.28805)
...
### [202] [Agent Explorative Policy Optimization for Multimodal Agentic Reasoning](https://arxiv.org/abs/2605.28774)
...
### [203] [Self-Improving Language Models with Bidirectional Evolutionary Search](https://arxiv.org/abs/2605.28814)
...
### [204] [VLMs May Not Globally Enhance Human Alignment over LLMs During Natural Reading](https://arxiv.org/abs/2605.28818)
...
### [205] [Actor-Identifier-Critic Reinforcement Learning for Adaptive Model-Free Optimal Control of Nonlinear Systems with Stochastic Packet Dropouts](https://arxiv.org/abs/2605.28569)
