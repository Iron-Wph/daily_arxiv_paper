...
Matched keywords: robotics, robot, manipulation, locomotion, humanoid, behavior cloning, reinforcement learning, sim-to-real
...
Matched keywords: embodied, robotics, robot, robot learning, vision-language-action, vla, multimodal
...
Matched keywords: robot, locomotion, imitation learning, reinforcement learning, sim-to-real, grasping
...
Matched keywords: robot, robotic manipulation, manipulation, contact-rich, teleoperation
...
Matched keywords: robot, vision-language-action, vla, vlm, reinforcement learning
...
Matched keywords: imitation learning, bimanual
...
Matched keywords: robot, humanoid, vision-language-action, vla
...
Matched keywords: robot, vision-language-action, world model
...
Matched keywords: embodied, navigation, vlm, tamp
...
Matched keywords: robotics, robot, mobile robot, foundation model
...
Matched keywords: embodied, robot, humanoid, vlm
...
Matched keywords: robot, manipulation, reinforcement learning, sim-to-real, grasping, contact-rich
...
Matched keywords: robot, pick and place
...
### [28] [Stability Control for Real World Testing in Autonomous Racing](https://arxiv.org/abs/2608.17779)
...
### [29] [CompCPZ: Preserving Multi-Modal Intent in Language-Guided Robot Manipulation](https://arxiv.org/abs/2608.17717)
...
Matched keywords: robot, manipulation, quadruped, vision-language-action, language-conditioned
...
Matched keywords: robot, manipulation, multimodal, tactile, contact-rich
...
### [35] [DeAR: Decentralized Agentic Reasoning via Capability Grounding and Collaborative Thought Navigation](https://arxiv.org/abs/2608.17282)
...
### [36] [LiveHouse-TS: An Open-world Living Benchmark for Time Series Foundation Models](https://arxiv.org/abs/2608.17299)
...
### [37] [SignalReasoner: Assessing the Upper Bound of 3B Models for Signal Mathematical Reasoning](https://arxiv.org/abs/2608.17301)
*Guozheng Sun*
...
### [38] [LEGO-RL: Harness-Native Reinforcement Learning for Coding Agents](https://arxiv.org/abs/2608.17393)
...
### [40] [StartupBench: Benchmarking General-Purpose Agents on Market-Validated End-to-End Workflows](https://arxiv.org/abs/2608.17800)
...
### [41] [ARASH: Adaptive Retrieval And Shot Selection for Tabular Prediction](https://arxiv.org/abs/2608.17856)
...
### [42] [Towards Zero-Shot Task Transfer with Neurosymbolic World Models](https://arxiv.org/abs/2608.17959)
...
### [44] [SW-ProxyCE: Zero-Query Adversarial Transfer from Public EEG Encoders to Private Downstream Models](https://arxiv.org/abs/2608.16931)
...
### [45] [MultiSigBERT: Beyond Survival Analysis through Multimodal and Sequential Modeling in Oncology](https://arxiv.org/abs/2608.16972)
...
### [46] [Q-Learning With World Models](https://arxiv.org/abs/2608.17163)
...
Matched keywords: robotics, robot, manipulation, vision-language-action, reinforcement learning, policy learning, world model
...
### [47] [SCENARIODIFF: A Scenario-level Guidance Framework for Multimodal Time Series Forecasting--Extended Version](https://arxiv.org/abs/2608.17164)
...
### [48] [Task Specialization Fine-Tuning for Contextual Reinforcement Learning](https://arxiv.org/abs/2608.17180)
...
### [49] [Reinforcement Learning as (Discrete) Potential Theory](https://arxiv.org/abs/2608.17181)
...
### [50] [An Omitted Mode Is a Rare Rule: The Sampling-Verification Danger Law in Continuous Code World Models](https://arxiv.org/abs/2608.17956)
...
### [51] [Co-RL: Unsupervised Reasoning Emerges from Diverse Cohort in Multi-agent RL](https://arxiv.org/abs/2608.17253)
...
### [52] [Repetition as Reinforcement: Enhancing Sample Efficiency via Instant Episode Repetition in Reinforcement Learning](https://arxiv.org/abs/2608.17347)
...
### [54] [Integrating Novelty and Surprise for Experience Prioritization and Exploration in Image-Based Reinforcement Learning](https://arxiv.org/abs/2608.17373)
...
### [55] [Evaluating RL Explainability Methods by How Much They Help Fix Bugs in Agents](https://arxiv.org/abs/2608.17524)
...
### [56] [No Gaussian Required: Contrastive Inverse Dynamics for JEPA World Models](https://arxiv.org/abs/2608.17542)
...
### [57] [Domain-Adapted Molecular Language Models for Efficient Search of Make-on-Demand Libraries](https://arxiv.org/abs/2608.17567)
...
### [58] [rl-triton: High-Performance Triton GPU Kernels for Reinforcement Learning Credit Assignment](https://arxiv.org/abs/2608.17641)
*Lars Simon Zehnder*
...
### [60] [Efficient RLVR Scheduling via Graph-Structured Online Difficulty Estimation](https://arxiv.org/abs/2608.17941)
...
### [61] [MoRAX: Mobility-based Representation Augmentation for Geospatial Foundation Models](https://arxiv.org/abs/2608.17848)
...
### [62] [Understanding the Surprising Generalization Properties of Tabular Foundation Models](https://arxiv.org/abs/2608.17957)
...
### [63] [Recirculation](https://arxiv.org/abs/2608.17981)
...
### [64] [Policy-Invariant Reward Shaping from LLM Feedback: A Framework for Hybrid RL Agents](https://arxiv.org/abs/2608.18008)
...
### [65] [Multi-Observer Vehicle Localization Case Study with Roadside Radar and Connected Vehicle Sensing](https://arxiv.org/abs/2608.16966)
...
### [66] [The 10th AI City Challenge](https://arxiv.org/abs/2608.17044)
...
### [67] [Inference-Time Attention Steering for Vision-Language-Action Driving Models](https://arxiv.org/abs/2608.17095)
...
### [68] [PROBE: Manipulation-Grounded Visual Question Answering with VLM Agents](https://arxiv.org/abs/2608.17129)
...
Matched keywords: robot, manipulation, vlm, sim-to-real, foundation model, grasping
...
### [69] [Lymphocyte Mimicry Correction via Region-Level Tissue Reasoning and Unbalanced Optimal Transport](https://arxiv.org/abs/2608.17151)
...
### [70] [Rapid Debris-Volume Estimation from Post-Hurricane Aerial Imagery](https://arxiv.org/abs/2608.17165)
...
### [71] [If, Then, Otherwise: Diagnosing Conditional Branching in Vision-Language Navigation](https://arxiv.org/abs/2608.17318)
...
### [72] [MS-MFAD : Multimodal large language models for Face Anti-spoofing Detection](https://arxiv.org/abs/2608.17328)
...
### [74] [REChart: Reasoning-Efficient Chart Editing with Large Reasoning Models](https://arxiv.org/abs/2608.17414)
...
### [75] [SemComp-Bench: Benchmarking Semantic Task Completion in Video Generation](https://arxiv.org/abs/2608.17426)
...
### [76] [NGS-Marker: Robust Native Watermarking for 3D Gaussian Splatting](https://arxiv.org/abs/2608.17447)
...
### [77] [S$^3$AM: A Single-Stream SAM with Reliability-Calibrated Frequency Adapter for Multi-modal Salient Object Detection](https://arxiv.org/abs/2608.17475)
...
### [78] [Training with synthetic data for drone detection in thermal imagery](https://arxiv.org/abs/2608.17799)
...
### [79] [When More Foundation Models Means Less: Diagnosing and Addressing Multi-View Fusion Failure](https://arxiv.org/abs/2608.17490)
...
### [80] [SE-MoLoRA: Shared-Expert LoRA Adapters for Domain-Specific Photographic Assessment](https://arxiv.org/abs/2608.17514)
...
### [81] [BrainNorm: A Foundation Model that knows Normal via Semantic Atlas Pretraining](https://arxiv.org/abs/2608.17521)
...
### [82] [GroupForward: Building Referable 3D Scenes via Instance-Grouped Feed-Forward Gaussian Splatting](https://arxiv.org/abs/2608.17535)
...
### [83] [Code as Representation: A Compilable Parsing Paradigm for Academic Documents](https://arxiv.org/abs/2608.17550)
...
### [84] [Leveraging existing sparse point annotations for benthic imagery dense segmentation](https://arxiv.org/abs/2608.17561)
...
### [85] [Where a New Concept Must Enter: Entry Point Gates Cross-Task Usability in Unified Multimodal Models](https://arxiv.org/abs/2608.17564)
...
### [86] [CoinVE-200K: A Large-Scale High-Quality Dataset for Compositional Instruction-Guided Video Editing](https://arxiv.org/abs/2608.17566)
...
### [87] [Environment-Invariant Subspace Learning for Generalizable Deepfake Detection](https://arxiv.org/abs/2608.17700)
...
### [88] [Vision-Language Models for Analog Gauge Reading: An Empirical Study of Specialization, Transfer and Reliability](https://arxiv.org/abs/2608.17723)
...
### [89] [Scale Matters: Adaptive Granularity Selection for Cross-Species 3D Plant Organ Segmentation](https://arxiv.org/abs/2608.17803)
...
### [90] [DistillPath: An Efficient 22M Distilled Pathology Encoder Approaching Large Foundation Model Performance](https://arxiv.org/abs/2608.17872)
...
### [91] [Improving Complex Moiré Removal with Generative Supervision](https://arxiv.org/abs/2608.17883)
...
### [92] [Beyond Instrument Motion: Recognizing Tissue Tension Toward Surgical Skill Assessment](https://arxiv.org/abs/2608.17935)
...
### [93] [Memory Tree Guided Key Frame Querying for Efficient 3D Question Answering](https://arxiv.org/abs/2608.18009)
...
### [94] [Plug-and-Play Traffic Element Awareness for End-to-End Autonomous Driving](https://arxiv.org/abs/2608.18035)
...
### [95] [From Corpora to Co-Evolving Capabilities: Capability-Centric Data Design for Generalist Image Generation](https://arxiv.org/abs/2608.18076)
...
### [96] [Foundation Agents Meet Agentic Deep Research: Evidence-Grounded Clinical Code Forecasting](https://arxiv.org/abs/2608.17075)
...
### [97] [Uncertainty-Aware Decision Making in Multimodal Large Language Models](https://arxiv.org/abs/2608.17084)
...
### [98] [There is No Theoretical Curse of Multilinguality For Embedding Space Structure](https://arxiv.org/abs/2608.17088)
...
### [99] [Emotion Across Speech and Faces: Shared Affective Mechanisms in Multimodal Foundation Models](https://arxiv.org/abs/2608.17102)
...
### [100] [Which Source Wins? Task-Dependent Reliance in Vision-Language Models](https://arxiv.org/abs/2608.17205)
...
### [101] [Auditing Exposure to Harmful Content on TikTok using Multimodal Language Models: A Cross-National, Age-Stratified Study](https://arxiv.org/abs/2608.17583)
...
### [102] [Write, Execute, Refine: From Skill Followers to Skill Optimizers via Reinforcement Learning from Execution Feedback](https://arxiv.org/abs/2608.17587)
...
### [103] [Multi-turn Conversational AI from Text to Multimodal Interaction: Data, Models, Evaluation, and Open Challenges](https://arxiv.org/abs/2608.17605)
...
### [104] [Thinking in a Low-Resource Language: What SFT Builds, What RL Fixes, What Accuracy Cannot See](https://arxiv.org/abs/2608.17744)
...
### [105] [BEAR-Bench: A Bilingual Enterprise and Academic Reasoning Benchmark for Multimodal Models](https://arxiv.org/abs/2608.17895)
...
### [106] [Physics-informed Reinforcement Learning for Stochastic Reach-Avoid Analysis](https://arxiv.org/abs/2608.17117)
...
### [107] [Safe Deep Reinforcement Learning for Energy-Efficient HVAC Control in Multi-Zone Residential Buildings](https://arxiv.org/abs/2608.17235)
...
### [108] [A Hybrid End-to-End and Modular Control Architecture Toward Safe Vehicle Lateral Control: Combining Soft Actor-Critic with Model Predictive Control](https://arxiv.org/abs/2608.17258)
*Farzaneh Tatari*
...
### [109] [Communication Reduction via Semantic-Based Encoding in DMPC Using LSTMs](https://arxiv.org/abs/2608.17592)
...
### [110] [Edge-Native Embodied Intelligence for Action-Aware Wireless Edge Networks](https://arxiv.org/abs/2608.17774)
