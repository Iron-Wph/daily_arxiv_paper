...
Matched keywords: vla, multimodal
...
Matched keywords: robot, locomotion, legged robot, sim-to-real
...
### [20] [TinySDP: Real Time Semidefinite Optimization for Certifiable and Agile Edge Robotics](https://arxiv.org/abs/2605.13748)
...
Matched keywords: robotics, robot, navigation, motion planning
...
Matched keywords: embodied, embodied intelligence, manipulation, tactile, bimanual
...
### [22] [Learning Responsibility-Attributed Adversarial Scenarios for Testing Autonomous Vehicles](https://arxiv.org/abs/2605.13751)
...
### [23] [Object Manipulation of the Variable Topology Truss system](https://arxiv.org/abs/2605.13086)
...
### [24] [Loiter UAV Reinsertion Guidance for Fixed-wing UAV Corridors](https://arxiv.org/abs/2605.13822)
...
### [25] [Identification of Non-Transversal Bifurcations of Linkages](https://arxiv.org/abs/2605.13094)
...
### [26] [What to Ignore, What to React: Visually Robust RL Fine-Tuning of VLA Models](https://arxiv.org/abs/2605.13105)
...
### [27] [SECOND-Grasp: Semantic Contact-guided Dexterous Grasping](https://arxiv.org/abs/2605.13117)
...
Matched keywords: robot, robotic manipulation, manipulation, dexterous, policy learning, grasping
...
### [28] [Towards Long-horizon Embodied Agents with Tool-Aligned Vision-Language-Action Models](https://arxiv.org/abs/2605.13119)
...
Matched keywords: embodied, robot, vision-language-action, vla, vlm, instruction following
...
### [29] [Multi-Depth Uniform Coverage Path Planning for Unmanned Surface Vehicle Surveying](https://arxiv.org/abs/2605.13123)
...
### [30] [MoCCA: A Movable Circle Probability of Collision Approximation](https://arxiv.org/abs/2605.13125)
...
### [31] [Dynamics Computation of Soft-Rigid Hybrid-Link System and Its Application to Motion Analysis of an Athlete Wearing Sport Prosthesis](https://arxiv.org/abs/2605.13192)
...
### [32] [Calibration-Free Gas Source Localization with Mobile Robots: Source Term Estimation Based on Concentration Measurement Ranking](https://arxiv.org/abs/2605.13208)
...
### [33] [Galilean State Estimation for Inertial Navigation Systems with Unknown Time Delay](https://arxiv.org/abs/2605.13266)
...
### [34] [HCSG: Human-Centric Semantic-Geometric Reasoning for Vision-Language Navigation](https://arxiv.org/abs/2605.13321)
...
### [35] [What Limits Vision-and-Language Navigation ?](https://arxiv.org/abs/2605.13328)
...
Matched keywords: embodied, embodied intelligence, robot, navigation, vision-language-action
...
### [36] [Exploring Human-Robot Collaboration: Analysis of Interaction Modalities in Challenging Tasks](https://arxiv.org/abs/2605.13380)
...
### [37] [BlockVLA: Accelerating Autoregressive VLA via Block Diffusion Finetuning](https://arxiv.org/abs/2605.13382)
...
Matched keywords: robotics, robot, vision-language-action, vla, diffusion policy
...
### [38] [RotVLA: Rotational Latent Action for Vision-Language-Action Model](https://arxiv.org/abs/2605.13403)
...
### [39] [SID: Sliding into Distribution for Robust Few-Demonstration Manipulation](https://arxiv.org/abs/2605.13428)
...
### [40] [Asymptotically Optimal Ergodic Coverage on Generalized Motion Fields](https://arxiv.org/abs/2605.13442)
...
Matched keywords: robotics, robot, legged robot, path planning
...
### [41] [CUBic: Coordinated Unified Bimanual Perception and Control Framework](https://arxiv.org/abs/2605.13452)
...
Matched keywords: robot, manipulation, policy learning, diffusion policy, visuomotor, bimanual
...
### [42] [Uncertainty-Aware 3D Position Refinement for Multi-UAV Systems](https://arxiv.org/abs/2605.13500)
...
### [43] [Integration of an Agent Model into an Open Simulation Architecture for Scenario-Based Testing of Automated Vehicles](https://arxiv.org/abs/2605.13539)
...
### [44] [AttenA+: Rectifying Action Inequality in Robotic Foundation Models](https://arxiv.org/abs/2605.13548)
...
### [45] [Design of Magnetic Continuum Robots with Tunable Force Response Using Rotational Ring Pairs](https://arxiv.org/abs/2605.13613)
...
### [46] [Guide, Think, Act: Interactive Embodied Reasoning in Vision-Language-Action Models](https://arxiv.org/abs/2605.13632)
...
Matched keywords: embodied, robot, vision-language-action, vla, multimodal, affordance
...
### [47] [Causality-Aware End-to-End Autonomous Driving via Ego-Centric Joint Scene Modeling](https://arxiv.org/abs/2605.13646)
...
### [48] [Robot Squid Game: Quadrupedal Locomotion for Traversing Narrow Tunnels](https://arxiv.org/abs/2605.13665)
...
Matched keywords: robot, locomotion, navigation, quadruped, reinforcement learning
...
### [49] [LEXI-SG: Monocular 3D Scene Graph Mapping with Room-Guided Feed-Forward Reconstruction](https://arxiv.org/abs/2605.13741)
...
Matched keywords: robot, manipulation, vision-language-action, vla, grasping, teleoperation
...
Matched keywords: embodied, embodied intelligence, vision-language-action, vla
...
### [55] [Think Twice, Act Once: Verifier-Guided Action Selection For Embodied Agents](https://arxiv.org/abs/2605.12620)
...
### [56] [Macro-Action Based Multi-Agent Instruction Following through Value Cancellation](https://arxiv.org/abs/2605.12655)
...
### [57] [Do Androids Dream of Breaking the Game? Systematically Auditing AI Agent Benchmarks with BenchJack](https://arxiv.org/abs/2605.12673)
...
### [58] [Revealing Interpretable Failure Modes of VLMs](https://arxiv.org/abs/2605.12674)
...
### [61] [Retrieval-Augmented Tutoring for Algorithm Tracing and Problem-Solving in AI Education](https://arxiv.org/abs/2605.12988)
...
### [62] [MAP: A Map-then-Act Paradigm for Long-Horizon Interactive Agent Reasoning](https://arxiv.org/abs/2605.13037)
...
### [63] [An Agentic AI Framework with Large Language Models and Chain-of-Thought for UAV-Assisted Logistics Scheduling with Mobile Edge Computing](https://arxiv.org/abs/2605.13221)
...
### [64] [It's not the Language Model, it's the Tool: Deterministic Mediation for Scientific Workflows](https://arxiv.org/abs/2605.13245)
...
### [65] [D-VLA: A High-Concurrency Distributed Asynchronous Reinforcement Learning Framework for Vision-Language-Action Models](https://arxiv.org/abs/2605.13276)
...
Matched keywords: embodied, embodied ai, vision-language-action, vla, multimodal, reinforcement learning, foundation model
...
### [66] [Ego2World: Compiling Egocentric Cooking Videos into Executable Worlds for Belief-State Planning](https://arxiv.org/abs/2605.13335)
...
Matched keywords: embodied, sim-to-real
...
### [67] [MMSkills: Towards Multimodal Skills for General Visual Agents](https://arxiv.org/abs/2605.13527)
...
### [68] [Scaling Retrieval-Augmented Reasoning with Parallel Search and Explicit Merging](https://arxiv.org/abs/2605.13534)
...
### [69] [Senses Wide Shut: A Representation-Action Gap in Omnimodal LLMs](https://arxiv.org/abs/2605.13737)
...
### [71] [Towards Robust Federated Multimodal Graph Learning under Modality Heterogeneity](https://arxiv.org/abs/2605.12584)
...
### [72] [Runtime Monitoring of Perception-Based Autonomous Systems via Embedding Temporal Logic](https://arxiv.org/abs/2605.12651)
...
### [73] [Plan Before You Trade: Inference-Time Optimization for RL Trading Agents](https://arxiv.org/abs/2605.12653)
...
### [74] [ODRPO: Ordinal Decompositions of Discrete Rewards for Robust Policy Optimization](https://arxiv.org/abs/2605.12667)
...
### [75] [Quantifying Potential Observation Missingness in Inverse Reinforcement Learning](https://arxiv.org/abs/2605.12831)
...
### [76] [Multitask Multimodal Fusion with Tabular Foundation Models for Peak and Durability Prediction of Pertussis Booster Response](https://arxiv.org/abs/2605.12852)
*Divya Sitani*
...
### [77] [Certified Robustness under Heterogeneous Perturbations via Hybrid Randomized Smoothing](https://arxiv.org/abs/2605.12876)
...
### [78] [VIP-COP: Context Optimization for Tabular Foundation Models](https://arxiv.org/abs/2605.12904)
...
### [79] [Revisiting DAgger in the Era of LLM-Agents](https://arxiv.org/abs/2605.12913)
...
### [80] [ERPPO: Entropy Regularization-based Proximal Policy Optimization](https://arxiv.org/abs/2605.13131)
...
### [81] [Trajectory-Level Data Augmentation for Offline Reinforcement Learning](https://arxiv.org/abs/2605.13401)
...
### [82] [Reinforced Collaboration in Multi-Agent Flow Networks](https://arxiv.org/abs/2605.12943)
...
### [83] [Revisiting Reinforcement Learning with Verifiable Rewards from a Contrastive Perspective](https://arxiv.org/abs/2605.12969)
...
### [84] [JEDI: Joint Embedding Diffusion World Model for Online Model-Based Reinforcement Learning](https://arxiv.org/abs/2605.13013)
...
### [85] [Bridging Domain Gaps with Target-Aligned Generation for Offline Reinforcement Learning](https://arxiv.org/abs/2605.13054)
...
### [86] [Ergodic Trajectory Design by Learned Pushforward Maps: Provable Coverage via Conditional Flow Matching](https://arxiv.org/abs/2605.13063)
...
### [87] [KAST-BAR: Knowledge-Anchored Semantically-Dynamic Topology Brain Autoregressive Modeling for Universal Neural Interpretation](https://arxiv.org/abs/2605.13133)
...
### [88] [Temper and Tilt Lead to SLOP: Reward Hacking Mitigation with Inference-Time Alignment](https://arxiv.org/abs/2605.13537)
...
### [89] [Multi-Objective and Mixed-Reward Reinforcement Learning via Reward-Decorrelated Policy Optimization](https://arxiv.org/abs/2605.13641)
...
### [90] [Finding the Weakest Link: Adversarial Attack against Multi-Agent Communications](https://arxiv.org/abs/2605.13170)
...
### [91] [Stable Attention Response for Reliable Precipitation Nowcasting](https://arxiv.org/abs/2605.13181)
...
### [92] [Switching Successor Measures for Hierarchical Zero-shot Reinforcement Learning](https://arxiv.org/abs/2605.13207)
...
### [93] [Machine Learning-Driven Multimodal Spectroscopic Liquid Biopsy for Early Multicancer Detection](https://arxiv.org/abs/2605.13218)
...
### [94] [Teacher-Guided Policy Optimization for LLM Distillation](https://arxiv.org/abs/2605.13230)
...
### [95] [Supervised Deep Multimodal Matrix Factorization for Interpretable Brain Network Analysis](https://arxiv.org/abs/2605.13312)
...
### [96] [GeoFlowVLM: Geometry-Aware Joint Uncertainty for Frozen Vision-Language Embedding](https://arxiv.org/abs/2605.13352)
...
### [97] [Strategic PAC Learnability via Geometric Definability](https://arxiv.org/abs/2605.13426)
...
### [98] [Q-Flow: Stable and Expressive Reinforcement Learning with Flow-Based Policy](https://arxiv.org/abs/2605.13435)
...
### [99] [Twincher: Bijective Representation Learning for Robust Inversion of Continuous Systems](https://arxiv.org/abs/2605.13470)
*Arkady Gonoskov*
...
### [100] [HLS-Seek: QoR-Aware Code Generation for High-Level Synthesis via Proxy Comparative Reward Reinforcement Learning](https://arxiv.org/abs/2605.13536)
...
### [101] [Decoupled and Divergence-Conditioned Prompt for Multi-domain Dynamic Graph Foundation Models](https://arxiv.org/abs/2605.13540)
...
### [102] [Self-Supervised On-Policy Reinforcement Learning via Contrastive Proximal Policy Optimisation](https://arxiv.org/abs/2605.13554)
...
### [103] [Dynamical Predictive Modelling of Cardiovascular Disease Progression Post-Myocardial Infarction via ECG-Trained Artificial Intelligence Model](https://arxiv.org/abs/2605.13568)
...
### [104] [Multimodal Graph-based Classification of Esophageal Motility Disorders](https://arxiv.org/abs/2605.13623)
...
### [105] [Achieving $ε^{-2}$ Sample Complexity for Single-Loop Actor-Critic under Minimal Assumptions](https://arxiv.org/abs/2605.13639)
...
### [106] [MILM: Large Language Models for Multimodal Irregular Time Series with Informative Sampling](https://arxiv.org/abs/2605.13711)
...
### [107] [Tight Sample Complexity Bounds for Entropic Best Policy Identification](https://arxiv.org/abs/2605.13717)
...
### [108] [Learning POMDP World Models from Observations with Language-Model Priors](https://arxiv.org/abs/2605.13740)
...
### [109] [GHGbench: A Unified Multi-Entity, Multi-Task Benchmark for Carbon Emission Prediction](https://arxiv.org/abs/2605.13743)
...
### [110] [Scale-Gest: Scalable Model-Space Synthesis and Runtime Selection for On-Device Gesture Detection](https://arxiv.org/abs/2605.12506)
...
### [111] [CROP: Expert-Aligned Image Cropping via Compositional Reasoning and Optimizing Preference](https://arxiv.org/abs/2605.12545)
...
### [112] [DistractMIA: Black-Box Membership Inference on Vision-Language Models via Semantic Distraction](https://arxiv.org/abs/2605.12574)
...
### [113] [TrackCraft3R: Repurposing Video Diffusion Transformers for Dense 3D Tracking](https://arxiv.org/abs/2605.12587)
...
### [114] [A Data Efficiency Study of Synthetic Fog for Object Detection Using the Clear2Fog Pipeline](https://arxiv.org/abs/2605.12608)
...
### [115] [CRAFT: Clinical Reward-Aligned Finetuning for Medical Image Synthesis](https://arxiv.org/abs/2605.12650)
...
### [116] [No One Knows the State of the Art in Geospatial Foundation Models](https://arxiv.org/abs/2605.12678)
...
### [117] [Visual Aesthetic Benchmark: Can Frontier Models Judge Beauty?](https://arxiv.org/abs/2605.12684)
...
### [118] [MMCL-Bench: Multimodal Context Learning from Visual Rules, Procedures, and Evidence](https://arxiv.org/abs/2605.12703)
...
### [119] [FRAME: Forensic Routing and Adaptive Multi-path Evidence Fusion for Image Manipulation Detection](https://arxiv.org/abs/2605.12826)
...
### [120] [AssemblyBench: Physics-Aware Assembly of Complex Industrial Objects](https://arxiv.org/abs/2605.12845)
...
### [121] [CRePE: Curved Ray Expectation Positional Encoding for Unified-Camera-Controlled Video Generation](https://arxiv.org/abs/2605.12938)
...
### [122] [Seg-Agent: Test-Time Multimodal Reasoning for Training-Free Language-Guided Segmentation](https://arxiv.org/abs/2605.12953)
...
### [123] [GTA: Advancing Image-to-3D World Generation via Geometry Then Appearance Video Diffusion](https://arxiv.org/abs/2605.12957)
...
### [124] [Reducing Bias and Variance: Generative Semantic Guidance and Bi-Layer Ensemble for Image Clustering](https://arxiv.org/abs/2605.12961)
...
### [125] [ViDR: Grounding Multimodal Deep Research Reports in Source Visual Evidence](https://arxiv.org/abs/2605.13034)
...
### [126] [CoGE: Sim-to-Real Online Geometric Estimation for Monocular Colonoscopy](https://arxiv.org/abs/2605.13038)
...
### [127] [EgoForce: Robust Online Egocentric Motion Reconstruction via Diffusion Forcing](https://arxiv.org/abs/2605.13041)
...
### [128] [Revealing the Gap in Human and VLM Scene Perception through Counterfactual Semantic Saliency](https://arxiv.org/abs/2605.13047)
...
### [129] [BrainAnytime: Anatomy-Aware Cross-Modal Pretraining for Brain Image Analysis with Arbitrary Modality Availability](https://arxiv.org/abs/2605.13059)
...
### [130] [Edit-Compass & EditReward-Compass: A Unified Benchmark for Image Editing and Reward Modeling](https://arxiv.org/abs/2605.13062)
...
### [131] [Learning to See What You Need: Gaze Attention for Multimodal Large Language Models](https://arxiv.org/abs/2605.13080)
...
### [132] [PRA-PoE: Robust Alzheimer's Diagnosis with Arbitrary Missing Modalities](https://arxiv.org/abs/2605.13081)
...
### [133] [Flow Augmentation and Knowledge Distillation for Lightweight Face Presentation Attack Detection](https://arxiv.org/abs/2605.13108)
...
### [134] [Early Semantic Grounding in Image Editing Models for Zero-Shot Referring Image Segmentation](https://arxiv.org/abs/2605.13122)
...
### [135] [EvObj: Learning Evolving Object-centric Representations for 3D Instance Segmentation without Scene Supervision](https://arxiv.org/abs/2605.13152)
...
### [136] [Dual-Pathway Circuits of Object Hallucination in Vision-Language Models](https://arxiv.org/abs/2605.13156)
...
### [137] [OmniLiDAR: A Unified Diffusion Framework for Multi-Domain 3D LiDAR Generation](https://arxiv.org/abs/2605.13815)
...
### [138] [PanoWorld: Towards Spatial Supersensing in 360$^\circ$ Panorama World](https://arxiv.org/abs/2605.13169)
...
### [139] [FIKA-Bench: From Fine-grained Recognition to Fine-Grained Knowledge Acquisition](https://arxiv.org/abs/2605.13193)
*Geng Li,Yuxin Peng*
...
### [140] [ReTool-Video: Recursive Tool-Using Video Agents with Meta-Augmented Tool Grounding](https://arxiv.org/abs/2605.13228)
...
### [141] [GRIP-VLM: Group-Relative Importance Pruning for Efficient Vision-Language Models](https://arxiv.org/abs/2605.13375)
...
### [142] [Backbone is All You Need: Assessing Vulnerabilities of Frozen Foundation Models in Synthetic Image Forensics](https://arxiv.org/abs/2605.13381)
...
### [143] [Towards Unified Surgical Scene Understanding:Bridging Reasoning and Grounding via MLLMs](https://arxiv.org/abs/2605.13530)
...
### [144] [HetScene: Heterogeneity-Aware Diffusion for Dense Indoor Scene Generation](https://arxiv.org/abs/2605.13586)
...
### [145] [Real2Sim: A Physics-driven and Editable Gaussian Splatting Framework for Autonomous Driving Scenes](https://arxiv.org/abs/2605.13591)
...
### [146] [SceneGraphVLM: Dynamic Scene Graph Generation from Video with Vision-Language Models](https://arxiv.org/abs/2605.13667)
...
### [147] [SpurAudio: A Benchmark for Studying Shortcut Learning in Few-Shot Audio Classification](https://arxiv.org/abs/2605.13672)
...
### [148] [Weakly Supervised Segmentation as Semantic-Based Regularization](https://arxiv.org/abs/2605.13674)
...
### [149] [MedCore: Boundary-Preserving Medical Core Pruning for MedSAM](https://arxiv.org/abs/2605.13688)
...
### [150] [Coordinating Multiple Conditions for Trajectory-Controlled Human Motion Generation](https://arxiv.org/abs/2605.13729)
...
### [152] [Training Long-Context Vision-Language Models Effectively with Generalization Beyond 128K Context](https://arxiv.org/abs/2605.13831)
...
### [153] [Bridging the Missing-Modality Gap: Improving Text-Only Calibration of Vision Language Models](https://arxiv.org/abs/2605.12517)
...
### [154] [Correct Answers from Sound Reasoning: Verifiable Process Supervision for Language Models](https://arxiv.org/abs/2605.12519)
...
### [155] [Training LLMs with Reinforcement Learning for Intent-Aware Personalized Question Answering](https://arxiv.org/abs/2605.12645)
...
### [156] [Simulating Students or Sycophantic Problem Solving? On Misconception Faithfulness of LLM Simulators](https://arxiv.org/abs/2605.12748)
...
### [157] [CiteVQA: Benchmarking Evidence Attribution for Trustworthy Document Intelligence](https://arxiv.org/abs/2605.12882)
...
### [158] [DiM\textsuperscript{3}: Bridging Multilingual and Multimodal Models via Direction- and Magnitude-Aware Merging](https://arxiv.org/abs/2605.12960)
...
### [159] [Leveraging Multimodal Self-Consistency Reasoning in Coding Motivational Interviewing for Alcohol Use Reduction](https://arxiv.org/abs/2605.12987)
...
### [160] [GeoBuildBench: A Benchmark for Interactive and Executable Geometry Construction from Natural Language](https://arxiv.org/abs/2605.13167)
...
### [161] [GAGPO: Generalized Advantage Grouped Policy Optimization](https://arxiv.org/abs/2605.13217)
...
### [162] [Utility-Oriented Visual Evidence Selection for Multimodal Retrieval-Augmented Generation](https://arxiv.org/abs/2605.13277)
...
### [163] [FIND: Toward Multimodal Financial Reasoning and Question Answering for Indic Languages](https://arxiv.org/abs/2605.13330)
...
### [164] [PDCR: Perception-Decomposed Confidence Reward for Vision-Language Reasoning](https://arxiv.org/abs/2605.13467)
...
### [165] [Relative Pose-Velocity Estimation Using Dual IMU Measurements and Relative Position Sensing](https://arxiv.org/abs/2605.13031)
...
### [166] [Submodular Multi-Agent Policy Learning for Online Distributed Task Allocation in Open Multi-Agent Systems](https://arxiv.org/abs/2605.13269)
