...
Matched keywords: robot, dexterity, tactile, teleoperation
...
Matched keywords: embodied, embodied ai, robot, robot learning, reinforcement learning, policy learning
...
Matched keywords: robot, quadruped, sim-to-real
...
Matched keywords: robot, manipulation, dexterous, locomotion, humanoid, contact-rich
...
Matched keywords: robotics, robot, task and motion planning, tamp, motion planning
...
Matched keywords: robot, manipulation, vision-language-action, vla, instruction following
...
Matched keywords: robot, robot learning, vision-language-action, vla, vlm
...
Matched keywords: robot, robot learning, robotic manipulation, manipulation, vlm, policy learning
...
Matched keywords: robot, navigation, vlm, world model
...
Matched keywords: robot, manipulation, motion planning, teleoperation
...
Matched keywords: robot, robotic manipulation, manipulation, dexterous, grasping
...
Matched keywords: robot, locomotion, quadruped, legged robot, imitation learning, reinforcement learning
...
Matched keywords: robot, manipulation, vlm, task and motion planning, tamp, motion planning
...
Matched keywords: robot, humanoid, sim-to-real, motion planning
...
Matched keywords: vision-language-action, imitation learning, behavior cloning
...
### [29] [Learning Hierarchical Skill Policies with Offline Quality-Diversity Reinforcement Learning](https://arxiv.org/abs/2608.19684)
...
### [30] [SafeBranch: Branch-Pair Safety Alignment for Embodied Agents](https://arxiv.org/abs/2608.19729)
...
Matched keywords: robot, robotic manipulation, manipulation, vision-language-action, vla, vlm, reinforcement learning, teleoperation
...
### [36] [DECOWAM: Decoupled Whole-Body World-Action Model for Legged Mobile Manipulation](https://arxiv.org/abs/2608.20114)
...
Matched keywords: robot, manipulation, mobile manipulation, locomotion
...
### [37] [Contrastive Mixed Prompt Learning for Incomplete Multimodal Sentiment Analysis with Unseen Modality Combination](https://arxiv.org/abs/2608.20019)
...
### [39] [Electronic Navigational Chart Change Classification](https://arxiv.org/abs/2608.20218)
...
### [40] [Rule-Compliant Visual Spatial Planning for Multimodal Large Language Models](https://arxiv.org/abs/2608.20237)
...
### [41] [Learning When to Think: Adaptive Reasoning for Test-Time Compute Allocation](https://arxiv.org/abs/2608.20256)
...
### [42] [Catching the Rug: Early Prediction of Fraudulent Memecoins on Solana via Machine Learning](https://arxiv.org/abs/2608.20271)
...
### [43] [MidTool: Mid-training Data Synthesis for Agentic Tool Use](https://arxiv.org/abs/2608.20314)
...
### [44] [An Agentic Approach for Active Data Collection, Travel Behavior Modeling, and Weather-Sensitive Demand Prediction](https://arxiv.org/abs/2608.20320)
...
### [45] [Holtercare-Bench: A Multimodal Benchmark for Evaluating Long-Term Dynamic ECG Analysis](https://arxiv.org/abs/2608.19297)
...
### [46] [Beyond Multimodal Alignment: Certifying Physical Language through Response Substitution and Ordered Execution](https://arxiv.org/abs/2608.19492)
...
### [47] [RecPFN: Prior-Fitted Networks for In-Context-Based Recommendations](https://arxiv.org/abs/2608.19735)
...
### [48] [MileGPO: Milestone Inference with Local Evidence for Graph-Based Policy Optimization of Long-Horizon LLM Agents](https://arxiv.org/abs/2608.19803)
...
### [49] [Answer-Level Trust Selection for Physical Vision-Language Reasoning](https://arxiv.org/abs/2608.19807)
...
### [57] [Clustering and Token Denoising for Faster and More Robust VLMs](https://arxiv.org/abs/2608.19285)
...
### [58] [SceneGTMM: A Conformal Mapping-based Scene-Aware Transferable GNN-Transformer Dual-Graph Interaction Framework for Map Matching](https://arxiv.org/abs/2608.19298)
...
### [59] [CVSD-Reg: Cross-Modal Visual Semantic Prior Distillation for Robust LiDAR Registration](https://arxiv.org/abs/2608.19536)
...
### [61] [MUST-PET: MUltimodal Self-supervised learning across Tracers for whole-body PET/CT-based lesion segmentation](https://arxiv.org/abs/2608.19666)
...
### [62] [Scaffolding Minds: Optimizing Latent Visual Target Representations for Multimodal Reasoning](https://arxiv.org/abs/2608.19669)
...
### [63] [RIPE++: Reinforced Keypoint Learning from Positive Pairs Only](https://arxiv.org/abs/2608.19693)
...
### [64] [Robust Cross-Modal Foundation Model Perception for Underwater Robots under Degraded Visual Conditions](https://arxiv.org/abs/2608.19710)
...
Matched keywords: robot, multimodal, foundation model
...
### [66] [Towards Surgical World-Action Modeling: A Preliminary Joint Visual-Trajectory Forecasting for Surgical Motion Planning](https://arxiv.org/abs/2608.20284)
...
### [67] [Open-Vocabulary 3D Object Detection with Co-Distillation Discovery and Dual Guidance Robust Training](https://arxiv.org/abs/2608.19973)
...
### [68] [From Street View Imagery to Street Quality Indicators: Vision Language Inference for the Suburban 15-minute City](https://arxiv.org/abs/2608.20026)
...
### [69] [V-REX: Efficient Specialist VLM Training for Veterinary X-Rays](https://arxiv.org/abs/2608.20069)
...
### [70] [ArmorOCR: Grounded Adversarial Visual Perception via Observation-Transferred Self-Distillation](https://arxiv.org/abs/2608.20122)
...
### [71] [ID-VTG: Image-Disambiguated Video Temporal Grounding](https://arxiv.org/abs/2608.20127)
...
### [72] [DPC-Net: Dual-Prior Collaborative Network for All-in-One Image Restoration](https://arxiv.org/abs/2608.20141)
...
### [73] [RoMAN-Flow: Taming Autoregressive Normalizing Flows for Offline Reinforcement Learning in Robotic Manipulation](https://arxiv.org/abs/2608.20208)
...
### [74] [DreamHand: Repurposing Video Diffusion Models for Occlusion-Robust Egocentric 3D Hand Motion Recovery](https://arxiv.org/abs/2608.20308)
...
Matched keywords: embodied, embodied ai, robot, manipulation, bimanual
...
### [75] [Inter-X++: A Comprehensive Benchmark for Multimodal Human-Human Interaction Analysis](https://arxiv.org/abs/2608.20312)
...
Matched keywords: dexterous, multimodal
...
### [76] [Swift-Image: Exploring the Performance Frontier of Compact Unified Image Generation Models](https://arxiv.org/abs/2608.20334)
...
### [77] [Compliance, Capability, and Conflict: Benchmarking Multimodal LLMs under System Messages](https://arxiv.org/abs/2608.19207)
...
### [78] [When Irrelevant Text Matters: Affine Margin Shifts in Multimodal Large Language Models](https://arxiv.org/abs/2608.19208)
...
### [79] [NepOOC-M: Bilingual Nepali-English Benchmark and Comparative Analysis of Multimodal Architectures for OOC Detection](https://arxiv.org/abs/2608.19212)
*Sanjeev Khatiwada*
...
### [80] [Time-Series Retrieval for Grounding Multimodal Language Models in Remaining Useful Life](https://arxiv.org/abs/2608.19218)
...
### [81] [Can Conversational AI loosen Us-Versus-Them Boundaries? The Effects of Common, Dual, and Separate Identity Framings on Pro-Immigrant Intergroup Helping](https://arxiv.org/abs/2608.19220)
...
### [82] [Projector Is All You Train](https://arxiv.org/abs/2608.19726)
...
### [83] [One Success Isn't Reliability: Thinkingbox, a Sandbox and Benchmark for Agents in Stateful Business Workflows](https://arxiv.org/abs/2608.19741)
...
### [84] [Dynamic Gated Cross-Modal Fusion with Sarcastic-aware Contrastive Regularization for Multimodal Sarcasm Detection](https://arxiv.org/abs/2608.19942)
...
### [85] [Robust Incomplete Multimodal Sentiment Analysis via Iterative Proxy Correction](https://arxiv.org/abs/2608.19971)
...
### [86] [G-CARL: Grounded Checklist-Aligned Reward Learning for Patient-Oriented Medical Report Interpretation](https://arxiv.org/abs/2608.20331)
...
### [87] [Wave-Based Bilateral Teleoperation between Nonlinear Manipulators with Direct Contact Force Feedback](https://arxiv.org/abs/2608.20043)
...
### [88] [Adaptive RBFNN Control of Uncertain Bilateral Teleoperation Systems with Delay-Dependent LMI Stability Conditions](https://arxiv.org/abs/2608.20182)
...
### [89] [Taming the Tilt: A Unified Pilot Control Concept for Transformational eVTOL Aircraft](https://arxiv.org/abs/2608.20300)
