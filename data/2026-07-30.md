...
Matched keywords: embodied, embodied ai, embodied intelligence, robotics, robot
...
Matched keywords: robot, manipulation, grasping, bimanual
...
Matched keywords: manipulation, mobile manipulation, multimodal, reinforcement learning
...
Matched keywords: manipulation, vision-language-action, vla, reinforcement learning, foundation model
...
Matched keywords: manipulation, mobile manipulation, vision-language-action, vla, world model
...
### [18] [NeoRacer: An Open, Standardized 1:12 Scale Autonomous Race Car for Benchmarking and Education](https://arxiv.org/abs/2607.26855)
...
### [19] [Route by Kinematics, Act by Observation: Kinematics-Supervised Expert Routing in MoE-Augmented VLA](https://arxiv.org/abs/2607.26807)
...
### [20] [Practice Makes Policies: Bootstrapping and Consolidating Robotic Capabilities from Zero Human Demonstrations](https://arxiv.org/abs/2607.26809)
...
Matched keywords: embodied, robot, robotic manipulation, manipulation, visuomotor
...
### [21] [Controlled Experiments on Lane Changing by Transitional Autonomous Vehicle: Dataset and Behavioral Insights](https://arxiv.org/abs/2607.27085)
...
### [22] [From Uncertainty to Determinism: Coarse-to-Fine Visual Floorplan Localization without Ray Matching](https://arxiv.org/abs/2607.26817)
...
### [23] [BioVLN: A Simulation Platform for Visual Language Navigation in Biomedical Laboratories](https://arxiv.org/abs/2607.26914)
...
### [24] [Dense Soft Weighting for Radar Ego-Velocity Estimation](https://arxiv.org/abs/2607.26980)
...
### [25] [SymmGrid: Super-Scaling On-Robot Learning with Parallelized Symmetries and Egocentric-Exocentric Visual Perception](https://arxiv.org/abs/2607.26985)
...
Matched keywords: robot, robot learning, manipulation, humanoid, policy learning
...
### [26] [RL$^2$-VLA: Adaptive RL Latent Compositional Steering with Test-Time Scaling for Vision-Language-Action Models](https://arxiv.org/abs/2607.26991)
...
Matched keywords: vision-language-action, vla, imitation learning, reinforcement learning, visuomotor
...
Matched keywords: embodied, embodied intelligence, robotics, robot, vision-language-action, multimodal, world model
...
### [35] [From Passive Video to Editable Experience: Physically Grounded Experience Synthesis for Embodied Intelligence](https://arxiv.org/abs/2607.26903)
*Jia Luo*
...
Matched keywords: embodied, embodied ai, embodied intelligence, robot, manipulation, affordance
...
### [36] [What Does It Take to Detect an AI Agent? Minimal Feature Sets for Behavioral Detection under Browser Automation](https://arxiv.org/abs/2607.26935)
...
### [37] [Emergent Sparsity in Frozen Random CNN Feature Extractors for Deep Reinforcement Learning](https://arxiv.org/abs/2607.26059)
*Scott M. Norton*
...
### [38] [Meta-Learned Reward Shaping for Reinforcement Learning from Human Feedback](https://arxiv.org/abs/2607.26094)
*Yunpeng Chu*
...
### [40] [Learning Implicit Causal World Models from Multi-Agent Demonstrations](https://arxiv.org/abs/2607.26336)
*Jasorsi Ghosh*
...
### [41] [MetaKoopman: Bayesian Meta-Learning of Koopman Operators for Modeling Structured Dynamics under Distribution Shifts](https://arxiv.org/abs/2607.26345)
...
### [42] [Post-Training at the Edge of Detectability: A Game-Theoretic Approach to Fine-Tuning](https://arxiv.org/abs/2607.26358)
...
### [43] [SCOUT: Per-Context Reset Curricula for Sparse-Reward Reinforcement Learning](https://arxiv.org/abs/2607.26417)
...
### [44] [DHRCL:Training Code LLMs with Dense Hierarchical Rewards and Curriculum Learning](https://arxiv.org/abs/2607.26457)
*Shuhang Wang,Ziming Li,Hui Cheng*
...
### [45] [Neural Architecture Search for Traffic Prediction: A Survey of Methods, Challenges, and Future Directions](https://arxiv.org/abs/2607.26467)
...
### [46] [Learning Dynamic User Personas from Implicit Interaction Streams via Iterative Refinement](https://arxiv.org/abs/2607.26473)
*Haifeng Wu*
...
### [47] [Conformal Changepoint Localization and Root Cause Analysis with Corrupted Observations](https://arxiv.org/abs/2607.26481)
...
### [48] [Collaborative Weighting with Pessimistic Critic for Mitigating Overestimation in Off-Policy Reinforcement Learning](https://arxiv.org/abs/2607.26509)
...
### [49] [HiFloat4 Format for End-To-End Reinforcement Learning Post-Training of Large Language Models](https://arxiv.org/abs/2607.26515)
...
### [50] [Temporally Centered SIGReg Improves Multi-Task LeWorldModel Learning: From Analysis to Method](https://arxiv.org/abs/2607.26924)
...
### [51] [AgentGFM: A Graph Foundation Model with Node-Agent Information-Flow Control](https://arxiv.org/abs/2607.26533)
...
### [52] [What Can Latent World Models Know? Physical Parameter Identifiability in Multimodal Predictive Representations](https://arxiv.org/abs/2607.27017)
...
### [53] [Efficient Heteroscedastic Bayesian Optimization for Risk-Aware AutoRL](https://arxiv.org/abs/2607.26680)
...
### [55] [SkillRise: Agentic Reinforcement Learning for Cross-Task Skill Evolution](https://arxiv.org/abs/2607.26784)
...
### [58] [Foundation Models for Face Presentation Attack Detection: A Unified Linear-Probing Benchmark](https://arxiv.org/abs/2607.26993)
...
### [59] [Equilibrium Training of Energy-Based Models with Parallel Trajectory Tempering](https://arxiv.org/abs/2607.27077)
...
### [60] [Minimal Markovization via Stable Quotients in Holonomy-Cover Decision Processes](https://arxiv.org/abs/2607.27132)
...
### [61] [When Do Learned Diffusion Proposals Help Constraint Solving? A Controlled Study on Continuous Algebraic Systems](https://arxiv.org/abs/2607.27169)
...
### [62] [Do You Really Need to Pretrain Q-Functions for Online RL Fine-Tuning?](https://arxiv.org/abs/2607.27203)
...
### [63] [TraceCLIP: Recovering Local Semantics from Patch-to-CLS Contributions](https://arxiv.org/abs/2607.26107)
...
### [64] [DVPSFormer: Efficient Online Depth-aware Video Panoptic Segmentation for Autonomous Driving](https://arxiv.org/abs/2607.26165)
...
### [65] [BG-REAL: A Public Real-Data Anchored Benchmark for Background Manipulation Detection and Localization](https://arxiv.org/abs/2607.26232)
...
### [66] [Comparing the Performance of Foundation Model Derived Embeddings with Traditional Approaches for Distant Metastasis Prediction in Head and Neck Cancer](https://arxiv.org/abs/2607.26276)
...
### [68] [Seeing or Knowing? Visual Context Sensitivity in Multimodal Large Language Models](https://arxiv.org/abs/2607.26326)
...
### [69] [Registration-Grounded Spectral Fusion for Unregistered WLI/NBI Endoscopic Lesion Segmentation](https://arxiv.org/abs/2607.26395)
...
### [70] [Do Unified Multimodal Models Think in One Space? A Lens Through Cross-Branch Steering](https://arxiv.org/abs/2607.26411)
*Yu Wang,Sharon Li*
...
### [72] [Forensic Reproducibility Audit of a Radiology Vision-Language Model Benchmark: From Intended Protocol to Released Artifact](https://arxiv.org/abs/2607.25589)
*Mateusz Kozłowski*
...
### [73] [Level, Sharpness, and Corpus: Why Zero-Shot OOD Detector Rankings Do Not Transfer](https://arxiv.org/abs/2607.26582)
...
### [74] [R-SLPR: Region-based Small-to-Large Point-cloud Registration with Contrastive Learning](https://arxiv.org/abs/2607.26583)
...
### [75] [HumanCLAW: Can Vision-Language Models Act Through a Body?](https://arxiv.org/abs/2607.27180)
...
### [76] [SpatialQ: Understanding 3D Gaussian Splatting Scene Quality via Visual-based MLLM](https://arxiv.org/abs/2607.26595)
...
### [78] [Decoupled Visual Processing: Efficient Multimodal Adaptation via Modality-Specific Transformer Substitution](https://arxiv.org/abs/2607.26596)
...
### [80] [Understanding Knowledge Transfer Mechanism in Heterogeneous MLLM Fusion: A Simple Linear Approach](https://arxiv.org/abs/2607.26608)
...
### [81] [FakeIDet3-DB: Refining Digital Attacks and Patch Extraction for Secure ID Benchmarking](https://arxiv.org/abs/2607.26641)
...
### [82] [Genie Sim PanoWorld: An Infinite Indoor 3D World Generation Pipeline via Panoramic Scene Modeling and Simulation](https://arxiv.org/abs/2607.26646)
...
### [83] [Anchoring and Steering Diffusion: Enhancing the Faithfulness of Text-to-Image Generation at Inference Time](https://arxiv.org/abs/2607.26647)
...
### [85] [StatePlay: State-Aware Game World Models for Mechanics-Consistent Generation](https://arxiv.org/abs/2607.26754)
...
### [86] [See2Think: Do Multimodal Models Really Use Intermediate Visual States?](https://arxiv.org/abs/2607.26769)
...
### [87] [Hearsay: Vision-Language Medical Diagnoses Without an Image](https://arxiv.org/abs/2607.26886)
*Siddharth Vohra*
...
### [88] [ICDAR 2026 Competition on Information Extraction from Atomic Layer Deposition/Etching (ALD/E) Scientific Figures](https://arxiv.org/abs/2607.26848)
...
### [89] [SCALPEL: Semantic Cross-modal Alignment via LLM-Powered Encoder Learning for Medical Vision-Language Representation](https://arxiv.org/abs/2607.26885)
...
### [90] [CinemaTraj: Composing Atomic Camera Trajectories for 3D Scenes with LLM Agents](https://arxiv.org/abs/2607.26910)
...
### [91] [Progressive Multimodal Alignment for Continual Instruction Tuning](https://arxiv.org/abs/2607.26947)
...
### [92] [Mitigating Compounding Error via Video Representation Regularization](https://arxiv.org/abs/2607.27036)
...
### [93] [SciFigAlign: Scoring Scientific Figures by Fine-tuned Alignment of Visuals with Manuscript Evidence](https://arxiv.org/abs/2607.27066)
...
### [94] [Visual Credit Audit for Multimodal Spatial Reasoning](https://arxiv.org/abs/2607.27069)
...
### [95] [Step-Attention Refinement of DINOv3 Features for Efficient Anterior Eye Segmentation](https://arxiv.org/abs/2607.27087)
...
### [96] [Towards Grounded GI Endoscopy VQA via Multi-Task Learning on Small VLMs](https://arxiv.org/abs/2607.27122)
...
### [97] [SeasonStereo: Robust Dense Stereo Matching for Multi-Date Satellite Imagery via Generative AI](https://arxiv.org/abs/2607.27139)
...
### [98] [Explainable and Resource-Efficient Spatial Reasoning in Multimodal LLMs for Decision-Critical Applications](https://arxiv.org/abs/2607.27145)
...
Matched keywords: embodied, embodied ai, robotics, robot, multimodal
...
### [99] [Anatomy Contextualized Adaption of CT Foundation Models](https://arxiv.org/abs/2607.27154)
...
### [100] [Symphony of Bias: Exploring Gender Associations with Musical Instruments in Multimodal LLMs](https://arxiv.org/abs/2607.26355)
...
### [102] [WikiLoop: Jointly Learning to Build and Navigate Agent-Native Wikis with Downstream Feedback](https://arxiv.org/abs/2607.26604)
...
### [103] [Filesystem-Based Memory for LLM Agents: Organization, Evolution, and Sustainability](https://arxiv.org/abs/2607.26637)
...
### [104] [Metis: Memory Foundation Model](https://arxiv.org/abs/2607.26760)
...
### [105] [SERPO: Self-Evolving Rubric Policy Optimization for Open-Ended Test-Time Reinforcement Learning](https://arxiv.org/abs/2607.26873)
...
### [106] [Dual-Path LLM Reasoning for Multimodal Few-Shot Knowledge Graph Completion](https://arxiv.org/abs/2607.26909)
...
### [107] [Mental World Modeling](https://arxiv.org/abs/2607.27201)
*Hao Fei,Yiran Zhao*
...
### [108] [Time-delay Control Using a New Nonlinear Adaptive Law for Cable-Driven Robots](https://arxiv.org/abs/2607.26383)
...
### [109] [Fully distributed singularity-free prescribed-time stabilization of the continuous-time generalized adaptive Bellman-Ford algorithm](https://arxiv.org/abs/2607.26424)
...
### [110] [Global Exponential Stabilization of the Kinematic Bicycle Model of a Car in Polar Coordinates](https://arxiv.org/abs/2607.26442)
...
### [111] [Global Sensitive-Based Input Shaping for UAV-Payload Precision Motion Control](https://arxiv.org/abs/2607.26717)
...
### [112] [Network Verified NTN Positioning for 6G A Standards Oriented Survey of Hybrid TN NTN Localization](https://arxiv.org/abs/2607.26846)
...
### [113] [Robotics: Science and Systems 2024](https://dblp.org/db/conf/rss/rss2024.html)
**
...
### [114] [Robotics: Science and Systems 2022](https://dblp.org/db/conf/rss/rss2022.html)
**
...
### [115] [Robotics: Science and Systems 2023](https://dblp.org/db/conf/rss/rss2023.html)
**
...
### [116] [Robotics: Science and Systems 2021](https://dblp.org/db/conf/rss/rss2021.html)
**
...
### [117] [Robotics: Science and Systems 2020](https://dblp.org/db/conf/rss/rss2020.html)
**
...
### [118] [Robotics: Science and Systems 2019](https://dblp.org/db/conf/rss/rss2019.html)
**
...
### [119] [Robotics: Science and Systems 2018](https://dblp.org/db/conf/rss/rss2018.html)
**
...
### [120] [Robotics: Science and Systems 2017](https://dblp.org/db/conf/rss/rss2017.html)
**
...
### [121] [Robotics: Science and Systems 2016](https://dblp.org/db/conf/rss/rss2016.html)
**
...
### [122] [Robotics: Science and Systems 2014](https://dblp.org/db/conf/rss/rss2014.html)
**
...
### [123] [Robotics: Science and Systems 2015](https://dblp.org/db/conf/rss/rss2015.html)
**
...
### [124] [Robotics: Science and Systems 2013](https://dblp.org/db/conf/rss/rss2013.html)
**
...
### [125] [Robotics: Science and Systems 2012](https://dblp.org/db/conf/rss/rss2012.html)
**
...
### [126] [Robotics: Science and Systems 2008](https://dblp.org/db/conf/rss/rss2008.html)
**
...
### [127] [Robotics: Science and Systems 2009](https://dblp.org/db/conf/rss/rss2009.html)
**
...
### [128] [Robotics: Science and Systems 2010](https://dblp.org/db/conf/rss/rss2010.html)
**
...
### [129] [Robotics: Science and Systems 2011](https://dblp.org/db/conf/rss/rss2011.html)
**
...
### [130] [Robotics: Science and Systems 2007](https://dblp.org/db/conf/rss/rss2007.html)
**
...
### [131] [Robotics: Science and Systems 2006](https://dblp.org/db/conf/rss/rss2006.html)
**
...
### [132] [Robotics: Science and Systems 2005](https://dblp.org/db/conf/rss/rss2005.html)
**
