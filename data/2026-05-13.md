...
Matched keywords: manipulation, vision-language-action, vla, foundation model
...
Matched keywords: robot, manipulation, vlm, multimodal, imitation learning, contact-rich
...
Matched keywords: robot, robotic manipulation, manipulation, language-conditioned, affordance
...
Matched keywords: robot, manipulation, vision-language-action, diffusion policy
...
Matched keywords: robotics, robot, robot learning, humanoid, vision-language-action, vla, teleoperation, bimanual
...
Matched keywords: robotics, robot, navigation, imitation learning, reinforcement learning, diffusion policy
...
Matched keywords: embodied, robot, humanoid, tactile
...
### [24] [EvoNav: Evolutionary Reward Function Design for Robot Navigation with Large Language Models](https://arxiv.org/abs/2605.11859)
...
### [28] [Closing the Motion Execution Gap: From Semantic Motion Task Constraints to Kinematic Control](https://arxiv.org/abs/2605.12053)
...
Matched keywords: embodied, embodied ai, robot, vision-language-action, vla, policy learning, world model, foundation model, teleoperation
...
Matched keywords: robot, manipulation, mobile manipulation, imitation learning, policy learning, bimanual
...
Matched keywords: robot, manipulation, vla, reinforcement learning
...
Matched keywords: robotics, robot, diffusion policy, tactile, contact-rich
...
Matched keywords: robot, humanoid, sim-to-real, sim2real, teleoperation
...
### [40] [RankQ: Offline-to-Online Reinforcement Learning via Self-Supervised Action Ranking](https://arxiv.org/abs/2605.11151)
*Andrew Choi,Wei Xu*
...
Matched keywords: robot, robot learning, vision-language-action, vla, behavior cloning, reinforcement learning, sim-to-real
...
### [41] [OLIVIA: Online Learning via Inference-time Action Adaptation for Decision Making in LLM ReAct Agents](https://arxiv.org/abs/2605.11169)
...
### [42] [Do Vision-Language-Models show human-like logical problem-solving capability in point and click puzzle games?](https://arxiv.org/abs/2605.11223)
...
### [43] [LatentRouter: Can We Choose the Right Multimodal Model Before Seeing Its Answer?](https://arxiv.org/abs/2605.11301)
...
### [44] [Hierarchical LLM-Driven Control for HAPS-Assisted UAV Networks: Joint Optimization of Flight and Connectivity](https://arxiv.org/abs/2605.11509)
...
### [45] [What Do EEG Foundation Models Capture from Human Brain Signals?](https://arxiv.org/abs/2605.11410)
...
### [46] [Breaking $\textit{Winner-Takes-All}$: Cooperative Policy Optimization Improves Diverse LLM Reasoning](https://arxiv.org/abs/2605.11461)
...
### [47] [CAMPA: Efficient and Aligned Multimodal Graph Learning via Decoupled Propagation and Aggregation](https://arxiv.org/abs/2605.11468)
...
### [48] [TOPPO: Rethinking PPO for Multi-Task Reinforcement Learning with Critic Balancing](https://arxiv.org/abs/2605.11473)
...
### [50] [CuSearch: Curriculum Rollout Sampling via Search Depth for Agentic RAG](https://arxiv.org/abs/2605.11611)
...
### [53] [Towards Visually Grounded Multimodal Summarization via Cross-Modal Transformer and Gated Attention](https://arxiv.org/abs/2605.11753)
...
### [54] [Beyond Inefficiency: Systemic Costs of Incivility in Multi-Agent Monte Carlo Simulations](https://arxiv.org/abs/2605.11789)
...
### [55] [Beyond World-Frame Action Heads: Motion-Centric Action Frames for Vision-Language-Action Models](https://arxiv.org/abs/2605.11809)
...
### [57] [When Simulation Lies: A Sim-to-Real Benchmark and Domain-Randomized RL Recipe for Tool-Use Agents](https://arxiv.org/abs/2605.11928)
...
### [58] [SAGE: A Self-Evolving Agentic Graph-Memory Engine for Structure-Aware Associative Memory](https://arxiv.org/abs/2605.12061)
...
### [59] [Rollout Cards: A Reproducibility Standard for Agent Research](https://arxiv.org/abs/2605.12131)
...
### [60] [MM-OptBench: A Solver-Grounded Benchmark for Multimodal Optimization Modeling](https://arxiv.org/abs/2605.12154)
...
### [61] [Do Enterprise Systems Need Learned World Models? The Importance of Context to Infer Dynamics](https://arxiv.org/abs/2605.12178)
...
### [62] [Why Conclusions Diverge from the Same Observations: Formalizing World-Model Non-Identifiability via an Inference](https://arxiv.org/abs/2605.12255)
*Toru Takahashi*
...
### [63] [How Useful Is Cross-Domain Generalization for Training LLM Monitors?](https://arxiv.org/abs/2605.12265)
...
### [64] [NARA: Anchor-Conditioned Relation-Aware Contextualization of Heterogeneous Geoentities](https://arxiv.org/abs/2605.12276)
...
### [65] [Towards Automated Air Traffic Safety Assessment Around Non-Towered Airports Using Large Language Models](https://arxiv.org/abs/2605.12332)
...
### [66] [Reinforcing VLAs in Task-Agnostic World Models](https://arxiv.org/abs/2605.12334)
...
Matched keywords: vision-language-action, vla, vlm, reinforcement learning, world model
...
### [67] [Semantic Reward Collapse and the Preservation of Epistemic Integrity in Adaptive AI Systems](https://arxiv.org/abs/2605.12406)
*William Parris*
...
### [68] [Towards Affordable Energy: A Gymnasium Environment for Electric Utility Demand-Response Programs](https://arxiv.org/abs/2605.12462)
...
### [69] [Reward Hacking in Rubric-Based Reinforcement Learning](https://arxiv.org/abs/2605.12474)
...
### [70] [Empowering VLMs for Few-Shot Multimodal Time Series Classification via Tailored Agentic Reasoning](https://arxiv.org/abs/2605.09395)
...
### [71] [$ξ$-DPO: Direct Preference Optimization via Ratio Reward Margin](https://arxiv.org/abs/2605.10981)
...
### [72] [TMPO: Trajectory Matching Policy Optimization for Diverse and Efficient Diffusion Alignment](https://arxiv.org/abs/2605.10983)
...
### [73] [Newton's Lantern: A Reinforcement Learning Framework for Finetuning AC Power Flow Warm Start Models](https://arxiv.org/abs/2605.11102)
...
### [74] [ACSAC: Adaptive Chunk Size Actor-Critic with Causal Transformer Q-Network](https://arxiv.org/abs/2605.11009)
...
### [75] [Efficient LLM Reasoning via Variational Posterior Guidance with Efficiency Awareness](https://arxiv.org/abs/2605.11019)
...
### [76] [Trust Region Inverse Reinforcement Learning: Explicit Dual Ascent using Local Policy Updates](https://arxiv.org/abs/2605.11020)
...
### [77] [ASD-Bench: A Four-Axis Comprehensive Benchmark of AI Models for Autism Spectrum Disorder](https://arxiv.org/abs/2605.11091)
...
Matched keywords: robot, robotic manipulation, manipulation, multimodal, reinforcement learning
...
### [79] [Variational Linear Attention: Stable Associative Memory for Long-Context Transformers](https://arxiv.org/abs/2605.11196)
...
### [80] [FeatMap: Understanding image manipulation in the feature space and its implications for feature space geometry](https://arxiv.org/abs/2605.11203)
...
### [81] [Localization Boosting for Growth Markets: Mitigating Cross-Locale Behavioral Bias in Learning-to-Rank](https://arxiv.org/abs/2605.11272)
...
### [82] [Quotient-Categorical Representations for Bellman-Compatible Average-Reward Distributional Reinforcement Learning](https://arxiv.org/abs/2605.11289)
...
### [83] [Epistemic Uncertainty for Test-Time Discovery](https://arxiv.org/abs/2605.11328)
...
### [84] [gym-invmgmt: An Open Benchmarking Framework for Inventory Management Methods](https://arxiv.org/abs/2605.11355)
...
### [85] [fg-expo: Frontier-guided exploration-prioritized policy optimization via adaptive kl and gaussian curriculum](https://arxiv.org/abs/2605.11403)
...
### [86] [20/20 Vision Language Models: A Prescription for Better VLMs through Data Curation Alone](https://arxiv.org/abs/2605.11405)
...
### [87] [MaskTab: Scalable Masked Tabular Pretraining with Scaling Laws and Distillation for Industrial Classification](https://arxiv.org/abs/2605.11408)
...
### [88] [Robust Multi-Agent Path Finding under Observation Attacks: A Principled Adversarial-Plus-Smoothing Training Recipe](https://arxiv.org/abs/2605.11469)
*Riad Ahmed*
...
### [89] [Understanding and Preventing Entropy Collapse in RLVR with On-Policy Entropy Flow Optimization](https://arxiv.org/abs/2605.11491)
...
### [90] [Entropy Polarity in Reinforcement Fine-Tuning: Direction, Asymmetry, and Control](https://arxiv.org/abs/2605.11775)
...
### [91] [GEAR: Granularity-Adaptive Advantage Reweighting for LLM Agents via Self-Distillation](https://arxiv.org/abs/2605.11853)
...
### [92] [OUI as a Structural Observable: Towards an Activation-Centric View of Neural Network Training](https://arxiv.org/abs/2605.11570)
...
### [93] [Predicting Decisions of AI Agents from Limited Interaction through Text-Tabular Modeling](https://arxiv.org/abs/2605.12411)
...
### [94] [ORCE: Order-Aware Alignment of Verbalized Confidence in Large Language Models](https://arxiv.org/abs/2605.12446)
...
### [95] [EpiCastBench: Datasets and Benchmarks for Multivariate Epidemic Forecasting](https://arxiv.org/abs/2605.11598)
...
### [96] [Evolutionary Task Discovery: Advancing Reasoning Frontiers via Skill Composition and Complexity Scaling](https://arxiv.org/abs/2605.11666)
...
### [97] [Compositional Neural Operators for Multi-Dimensional Fluid Dynamics](https://arxiv.org/abs/2605.11691)
...
### [98] [Block-R1: Rethinking the Role of Block Size in Multi-domain Reinforcement Learning for Diffusion Large Language Models](https://arxiv.org/abs/2605.11726)
...
### [99] [U-STS-LLM A Unified Spatio-Temporal Steered Large Language Model for Traffic Prediction and Imputation](https://arxiv.org/abs/2605.11735)
*Yichen Zhang,Jun Li*
...
### [100] [Federated Client Selection under Partial Visibility: A POMDP Approach with Spatio-Temporal Attention](https://arxiv.org/abs/2605.11752)
...
### [101] [Beyond Parameter Aggregation: Semantic Consensus for Federated Fine-Tuning of LLMs](https://arxiv.org/abs/2605.11857)
...
### [102] [Information theoretic underpinning of self-supervised learning by clustering](https://arxiv.org/abs/2605.11870)
...
### [103] [STAGE: Tackling Semantic Drift in Multimodal Federated Graph Learning](https://arxiv.org/abs/2605.11919)
...
### [104] [Towards Order Fairness: Mitigating LLMs Order Sensitivity through Dual Group Advantage Optimization](https://arxiv.org/abs/2605.11974)
...
### [105] [Stochastic Minimum-Cost Reach-Avoid Reinforcement Learning](https://arxiv.org/abs/2605.11975)
...
### [106] [Split the Differences, Pool the Rest: Provably Efficient Multi-Objective Imitation](https://arxiv.org/abs/2605.12000)
...
### [107] [Efficient and Adaptive Human Activity Recognition via LLM Backbones](https://arxiv.org/abs/2605.12019)
...
### [108] [Resilient Vision-Tabular Multimodal Learning under Modality Missingness](https://arxiv.org/abs/2605.12031)
...
### [109] [Missing Old Logits in Asynchronous Agentic RL: Semantic Mismatch and Repair Methods for Off-Policy Correction](https://arxiv.org/abs/2605.12070)
...
### [110] [Disentangled Sparse Representations for Concept-Separated Diffusion Unlearning](https://arxiv.org/abs/2605.12122)
...
### [111] [Overtrained, Not Misaligned](https://arxiv.org/abs/2605.12199)
...
### [112] [Investigating simple target-covariate relationships for Chronos-2 and TabPFN-TS](https://arxiv.org/abs/2605.12200)
...
### [113] [On the Importance of Multistability for Horizon Generalization in Reinforcement Learning](https://arxiv.org/abs/2605.12206)
...
### [114] [Intrinsic Vicarious Conditioning for Deep Reinforcement Learning](https://arxiv.org/abs/2605.12224)
...
### [115] [Instruction Lens Score: Your Instruction Contributes a Powerful Object Hallucination Detector for Multimodal Large Language Models](https://arxiv.org/abs/2605.12258)
...
### [116] [Delay-Empowered Causal Hierarchical Reinforcement Learning](https://arxiv.org/abs/2605.12261)
...
### [117] [PriorZero: Bridging Language Priors and World Models for Decision Making](https://arxiv.org/abs/2605.12289)
...
### [118] [In-context learning to predict critical transitions in dynamical systems](https://arxiv.org/abs/2605.12308)
...
### [119] [Transferable Delay-Aware Reinforcement Learning via Implicit Causal Graph Modeling](https://arxiv.org/abs/2605.12312)
...
### [120] [Autoregressive Learning in Joint KL: Sharp Oracle Bounds and Lower Bounds](https://arxiv.org/abs/2605.12316)
...
### [121] [Manifold Sampling via Entropy Maximization](https://arxiv.org/abs/2605.12338)
...
### [122] [BSO: Safety Alignment Is Density Ratio Matching](https://arxiv.org/abs/2605.12339)
...
### [123] [Discrete Flow Matching for Offline-to-Online Reinforcement Learning](https://arxiv.org/abs/2605.12379)
...
### [124] [Trust the Batch, On- or Off-Policy: Adaptive Policy Optimization for RL Post-Training](https://arxiv.org/abs/2605.12380)
...
### [125] [Aligning Flow Map Policies with Optimal Q-Guidance](https://arxiv.org/abs/2605.12416)
...
Matched keywords: robot, robotic manipulation, manipulation, locomotion, multimodal, reinforcement learning
...
### [126] [HiDream-O1-Image: A Natively Unified Image Generative Foundation Model with Pixel-level Unified Transformer](https://arxiv.org/abs/2605.11061)
...
### [127] [Birds of a Feather Flock Together: Background-Invariant Representations via Linear Structure in VLMs](https://arxiv.org/abs/2605.11107)
...
### [128] [Hi-GaTA: Hierarchical Gated Temporal Aggregation Adapter for Surgical Video Report Generation](https://arxiv.org/abs/2605.11208)
...
### [129] [ABRA: Agent Benchmark for Radiology Applications](https://arxiv.org/abs/2605.11224)
...
### [130] [DenseTRF: Texture-Aware Unsupervised Representation Adaptation for Surgical Scene Dense Prediction](https://arxiv.org/abs/2605.11265)
...
### [131] [Vision2Code: A Multi-Domain Benchmark for Evaluating Image-to-Code Generation](https://arxiv.org/abs/2605.11307)
...
### [134] [JACoP: Joint Alignment for Compliant Multi-Agent Prediction](https://arxiv.org/abs/2605.11385)
...
### [135] [Instruct-ICL: Instruction-Guided In-Context Learning for Post-Disaster Damage Assessment](https://arxiv.org/abs/2605.11439)
...
### [136] [Leveraging Multimodal Large Language Models for All-in-One Image Restoration via a Mixture of Frequency Experts](https://arxiv.org/abs/2605.11444)
...
### [137] [LDDR: Linear-DPP-Based Dynamic-Resolution Frame Sampling for Video MLLMs](https://arxiv.org/abs/2605.11477)
...
### [138] [PointGS: Semantic-Consistent Unsupervised 3D Point Cloud Segmentation with 3D Gaussian Splatting](https://arxiv.org/abs/2605.11520)
...
### [139] [GeoR-Bench: Evaluating Geoscience Visual Reasoning](https://arxiv.org/abs/2605.11541)
...
### [140] [The DAWN of World-Action Interactive Models](https://arxiv.org/abs/2605.11550)
...
### [141] [Weather-Robust Cross-View Geo-Localization via Prototype-Based Semantic Part Discovery](https://arxiv.org/abs/2605.11654)
...
### [142] [TriBand-BEV: Real-Time LiDAR-Only 3D Pedestrian Detection via Height-Aware BEV and High-Resolution Feature Fusion](https://arxiv.org/abs/2605.12220)
...
### [143] [When Looking Is Not Enough: Visual Attention Structure Reveals Hallucination in MLLMs](https://arxiv.org/abs/2605.11559)
...
### [144] [EgoEV-HandPose: Egocentric 3D Hand Pose Estimation and Gesture Recognition with Stereo Event Cameras](https://arxiv.org/abs/2605.12297)
...
Matched keywords: robotics, robot, bimanual
...
### [145] [Dynamic Execution Commitment of Vision-Language-Action Models](https://arxiv.org/abs/2605.11567)
...
### [146] [Logit-Attention Divergence: Mitigating Position Bias in Multi-Image Retrieval via Attention-Guided Calibration](https://arxiv.org/abs/2605.11591)
...
### [147] [HorizonDrive: Self-Corrective Autoregressive World Model for Long-horizon Driving Simulation](https://arxiv.org/abs/2605.11596)
...
### [148] [Keep What Audio Cannot Say: Context-Preserving Token Pruning for Omni-LLMs](https://arxiv.org/abs/2605.11605)
...
### [149] [Grounding by Remembering: Cross-Scene and In-Scene Memory for 3D Functional Affordances](https://arxiv.org/abs/2605.11616)
...
Matched keywords: vlm, affordance
...
### [150] [Unlocking UML Class Diagram Understanding in Vision Language Models](https://arxiv.org/abs/2605.11634)
...
### [151] [Hide to See: Reasoning-prefix Masking for Visual-anchored Thinking in VLM Distillation](https://arxiv.org/abs/2605.11651)
...
### [152] [ShapeCodeBench: A Renewable Benchmark for Perception-to-Program Reconstruction of Synthetic Shape Scenes](https://arxiv.org/abs/2605.11680)
*Shivam Kumar*
...
### [153] [DORA: Dynamic Online Reinforcement Agent for Token Merging in Vision Transformers](https://arxiv.org/abs/2605.11683)
...
### [154] [WildRelight: A Real-World Benchmark and Physics-Guided Adaptation for Single-Image Relighting](https://arxiv.org/abs/2605.11696)
...
### [155] [CAST: Collapse-Aware multi-Scale Topology Fusion for Multimodal Coreset Selection](https://arxiv.org/abs/2605.11705)
...
### [156] [CaC: Advancing Video Reward Models via Hierarchical Spatiotemporal Concentrating](https://arxiv.org/abs/2605.11723)
...
### [157] [BronchoLumen: Analysis of recent YOLO-based architectures for real-time bronchial orifice detection in video bronchoscopy](https://arxiv.org/abs/2605.11748)
...
### [158] [Focusable Monocular Depth Estimation](https://arxiv.org/abs/2605.11756)
...
### [159] [M$^4$-SAM: Multi-Modal Mixture-of-Experts with Memory-Augmented SAM for RGB-D Video Salient Object Detection](https://arxiv.org/abs/2605.11760)
...
### [160] [Urban Risk-Aware Navigation via VQA-Based Event Maps for People with Low Vision](https://arxiv.org/abs/2605.11782)
...
### [161] [SB-BEVFusion: Enhancing the Robustness against Sensor Malfunction and Corruptions](https://arxiv.org/abs/2605.11799)
...
### [163] [UniVLR: Unifying Text and Vision in Visual Latent Reasoning for Multimodal LLMs](https://arxiv.org/abs/2605.11856)
...
### [164] [When Brains Disagree: Biological Ambiguity Underlies the Challenge of Amyloid PET Synthesis from Structural MRI](https://arxiv.org/abs/2605.11867)
...
### [165] [Learn to Think: Improving Multimodal Reasoning through Vision-Aware Self-Improvement Training](https://arxiv.org/abs/2605.11931)
...
### [166] [Cluster-Aware Neural Collapse Prompt Tuning for Long-Tailed Generalization of Vision-Language Models](https://arxiv.org/abs/2605.11939)
...
### [167] [Multimodal Abstractive Summarization of Instructional Videos with Vision-Language Models](https://arxiv.org/abs/2605.11959)
...
### [168] [EDGER: EDge-Guided with HEatmap Refinement for Generalizable Image Forgery Localization](https://arxiv.org/abs/2605.12002)
...
### [169] [4DVGGT-D: 4D Visual Geometry Transformer with Improved Dynamic Depth Estimation](https://arxiv.org/abs/2605.12027)
...
### [170] [OmniHumanoid: Streaming Cross-Embodiment Video Generation with Paired-Free Adaptation](https://arxiv.org/abs/2605.12038)
...
Matched keywords: embodied, embodied intelligence, robot, humanoid
...
### [171] [Design Your Ad: Personalized Advertising Image and Text Generation with Unified Autoregressive Models](https://arxiv.org/abs/2605.12138)
...
### [172] [UniCustom: Unified Visual Conditioning for Multi-Reference Image Generation](https://arxiv.org/abs/2605.12088)
...
### [173] [Cross-Modal-Domain Generalization Through Semantically Aligned Discrete Representations](https://arxiv.org/abs/2605.12145)
...
### [174] [Self-Consistent Latent Reasoning: Long Latent Sequence Reasoning for Vision-Language Model](https://arxiv.org/abs/2605.12163)
...
### [175] [Beyond Text Prompts: Visual-to-Visual Generation as A Unified Paradigm](https://arxiv.org/abs/2605.12271)
...
### [176] [Large-Small Model Collaboration for Farmland Semantic Change Detection](https://arxiv.org/abs/2605.12282)
...
### [177] [Images in Sentences: Scaling Interleaved Instructions for Unified Visual Generation](https://arxiv.org/abs/2605.12305)
...
### [178] [G$^2$TR: Generation-Guided Visual Token Reduction for Separate-Encoder Unified Multimodal Models](https://arxiv.org/abs/2605.12309)
...
### [179] [Contrastive Learning under Noisy Temporal Self-Supervision for Colonoscopy Videos](https://arxiv.org/abs/2605.12320)
...
### [180] [Fill the GAP: A Granular Alignment Paradigm for Visual Reasoning in Multimodal Large Language Models](https://arxiv.org/abs/2605.12374)
...
### [181] [Beyond Localization: A Comprehensive Diagnosis of Perspective-Conditioned Spatial Reasoning in MLLMs from Omnidirectional Images](https://arxiv.org/abs/2605.12413)
...
### [182] [3D Gaussian Splatting for Efficient Retrospective Dynamic Scene Novel View Synthesis with a Standardized Benchmark](https://arxiv.org/abs/2605.12437)
...
### [183] [LychSim: A Controllable and Interactive Simulation Framework for Vision Research](https://arxiv.org/abs/2605.12449)
...
### [184] [OmniNFT: Modality-wise Omni Diffusion Reinforcement for Joint Audio-Video Generation](https://arxiv.org/abs/2605.12480)
...
### [185] [Elastic Attention Cores for Scalable Vision Transformers](https://arxiv.org/abs/2605.12491)
...
### [186] [AlphaGRPO: Unlocking Self-Reflective Multimodal Generation in UMMs via Decompositional Verifiable Reward](https://arxiv.org/abs/2605.12495)
...
### [187] [EgoForce: Forearm-Guided Camera-Space 3D Hand Pose from a Monocular Egocentric Camera](https://arxiv.org/abs/2605.12498)
...
### [188] [SenseNova-U1: Unifying Multimodal Understanding and Generation with NEO-unify Architecture](https://arxiv.org/abs/2605.12500)
...
Matched keywords: vision-language-action, vla, multimodal, world model
...
### [189] [ReVision: Scaling Computer-Use Agents via Temporal Visual Redundancy Reduction](https://arxiv.org/abs/2605.11212)
...
### [190] [Agent-BRACE: Decoupling Beliefs from Actions in Long-Horizon Tasks via Verbalized State Uncertainty](https://arxiv.org/abs/2605.11436)
...
### [191] [Checkup2Action: A Multimodal Clinical Check-up Report Dataset for Patient-Oriented Action Card Generation](https://arxiv.org/abs/2605.11533)
...
### [192] [When Emotion Becomes Trigger: Emotion-style dynamic Backdoor Attack Parasitising Large Language Models](https://arxiv.org/abs/2605.11612)
...
### [193] [OmniThoughtVis: A Scalable Distillation Pipeline for Deployable Multimodal Reasoning Models](https://arxiv.org/abs/2605.11629)
...
### [194] [Human-Grounded Multimodal Benchmark with 900K-Scale Aggregated Student Response Distributions from Japan's National Assessment of Academic Ability](https://arxiv.org/abs/2605.11663)
...
### [195] [Qwen-Scope: Turning Sparse Features into Development Tools for Large Language Models](https://arxiv.org/abs/2605.11887)
...
### [200] [SkillGraph: Skill-Augmented Reinforcement Learning for Agents via Evolving Skill Graphs](https://arxiv.org/abs/2605.12039)
...
### [201] [Is Child-Directed Language Optimized for Word Learning? A Computational Study of Verb Meaning Acquisition](https://arxiv.org/abs/2605.12047)
...
### [202] [Combining On-Policy Optimization and Distillation for Long-Context Reasoning in Large Language Models](https://arxiv.org/abs/2605.12227)
...
### [203] [PreScam: A Benchmark for Predicting Scam Progression from Early Conversations](https://arxiv.org/abs/2605.12243)
...
### [204] [TokenRatio: Principled Token-Level Preference Optimization via Ratio Matching](https://arxiv.org/abs/2605.12288)
...
### [207] [Basilisk and Docker for Reproducible GN&C Simulation: A Workflow Reference](https://arxiv.org/abs/2605.12443)
*Anubhav Gupta*
