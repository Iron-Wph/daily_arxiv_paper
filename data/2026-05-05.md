...
Matched keywords: robotics, robot, multimodal, world model
...
Matched keywords: robot, multimodal, grasping
...
Matched keywords: robotics, robot, imitation learning, visuomotor
...
Matched keywords: manipulation, imitation learning, policy learning, visuomotor, contact-rich
...
Matched keywords: robot, humanoid, teleoperation
...
Matched keywords: robot, manipulation, dexterous, multimodal, tactile
...
Matched keywords: robot, navigation, mobile robot, humanoid
...
Matched keywords: robot, manipulation, humanoid, visuomotor
...
Matched keywords: robot, imitation learning, policy learning
...
Matched keywords: robot, robotic manipulation, manipulation, diffusion policy, visuomotor
...
Matched keywords: embodied, embodied intelligence, robot, vision-language-action, vla, multimodal
...
Matched keywords: robot, task and motion planning, tamp, motion planning
...
Matched keywords: motion planning, path planning
...
Matched keywords: robot, robotic manipulation, manipulation, vision-language-action, vla, policy learning, grasping, teleoperation
...
Matched keywords: robot, manipulation, locomotion, navigation
...
### [41] [Natural Gradient Bayesian Filtering: Geometry-Aware Filter for Dynamical Systems](https://arxiv.org/abs/2605.02306)
...
Matched keywords: robot, quadruped, motion planning
...
### [44] [Exact Higher-Order Derivatives for SE(3) via Analytical/AD Methods](https://arxiv.org/abs/2605.02252)
*Frank O. Kuehnel*
...
### [46] [SAGA: A Robust Self-Attention and Goal-Aware Anchor-based Planner for Safe UAV Autonomous Navigation](https://arxiv.org/abs/2605.02301)
...
### [47] [ShapeGrasp: Simultaneous Visuo-Haptic Shape Completion and Grasping for Improved Robot Manipulation](https://arxiv.org/abs/2605.02347)
...
Matched keywords: embodied, robotics, robot, teleoperation
...
Matched keywords: navigation, reinforcement learning, sim-to-real
...
Matched keywords: robotics, robot, robotic manipulation, manipulation, vla, vlm, sim-to-real, contact-rich
...
Matched keywords: robotics, robot, robotic manipulation, manipulation, navigation, foundation model, grasping
...
### [58] [Learning Equivariant Neural-Augmented Object Dynamics From Few Interactions](https://arxiv.org/abs/2605.02699)
...
### [59] [Temporally Consistent Object 6D Pose Estimation for Robot Control](https://arxiv.org/abs/2605.02708)
...
### [60] [Tensegrity crutches with compliance from a pre-stressed self-tensile module improve ground reaction force profiles, speed, effort, comfort, and perceived stability](https://arxiv.org/abs/2605.02710)
...
### [61] [Parking Assistance for Trailer-Truck Transport Vehicles Using Sensor Fusion and Motion Planning](https://arxiv.org/abs/2605.02716)
...
### [62] [Latent Bridge: Feature Delta Prediction for Efficient Dual-System Vision-Language-Action Model Inference](https://arxiv.org/abs/2605.02739)
...
### [63] [DynoSLAM: Dynamic SLAM with Generative Graph Neural Networks for Real-World Social Navigation](https://arxiv.org/abs/2605.02759)
...
Matched keywords: robot, navigation, multimodal, world model
...
### [64] [LiDAR Teach, Radar Repeat: Robust Cross-Modal Navigation in Degenerate and Varying Environments](https://arxiv.org/abs/2605.02809)
...
### [65] [Semantic Risk-Aware Heuristic Planning for Robotic Navigation in Dynamic Environments: An LLM-Inspired Approach](https://arxiv.org/abs/2605.02862)
...
### [66] [MolmoAct2: Action Reasoning Models for Real-world Deployment](https://arxiv.org/abs/2605.02881)
...
Matched keywords: embodied, robotics, robot, vision-language-action, vla, vlm, bimanual
...
### [68] [A Knowledge-Driven LLM-Based Decision-Support System for Explainable Defect Analysis and Mitigation Guidance in Laser Powder Bed Fusion](https://arxiv.org/abs/2605.01100)
...
### [69] [PERSA: Reinforcement Learning for Professor-Style Personalized Feedback with LLMs](https://arxiv.org/abs/2605.01123)
...
### [70] [Zero-Shot Signal Temporal Logic Planning with Disjunctive Branch Selection in Dynamic Semantic Maps](https://arxiv.org/abs/2605.01222)
...
### [71] [EO-Gym: A Multimodal, Interactive Environment for Earth Observation Agents](https://arxiv.org/abs/2605.01250)
...
### [72] [Valley3: Scaling Omni Foundation Models for E-commerce](https://arxiv.org/abs/2605.01278)
...
### [73] [Lifting Traces to Logic: Programmatic Skill Induction with Neuro-Symbolic Learning for Long-Horizon Agentic Tasks](https://arxiv.org/abs/2605.01293)
...
### [74] [Segment-Aligned Policy Optimization for Multi-Modal Reasoning](https://arxiv.org/abs/2605.01327)
...
### [75] [DiagramNet: An End-to-End Recognition Framework and Dataset for Non-Standard System-Level Diagrams](https://arxiv.org/abs/2605.01338)
...
### [76] [Grounding Multi-Hop Reasoning in Structural Causal Models via Group Relative Policy Optimization](https://arxiv.org/abs/2605.01482)
...
### [77] [SciResearcher: Scaling Deep Research Agents for Frontier Scientific Reasoning](https://arxiv.org/abs/2605.01489)
...
### [78] [Latent State Design for World Models under Sufficiency Constraints](https://arxiv.org/abs/2605.01694)
*Keon Woo Kim*
...
### [79] [Catching the Infection Before It Spreads: Foresight-Guided Defense in Multi-Agent Systems](https://arxiv.org/abs/2605.01758)
...
### [80] [Runtime Evaluation of Procedural Content Generation in an Endless Runner Game Using Autonomous Agents](https://arxiv.org/abs/2605.01783)
*Rishabh Kar*
...
### [81] [DataEvolver: Let Your Data Build and Improve Itself via Goal-Driven Loop Agents](https://arxiv.org/abs/2605.01789)
...
### [83] [Reinforcement Learning Trained Observer Control for Bearings-Only Tracking](https://arxiv.org/abs/2605.02120)
...
### [84] [Planner Matters! An Efficient and Unbalanced Multi-agent Collaboration Framework for Long-horizon Planning](https://arxiv.org/abs/2605.02168)
...
### [85] [T$^2$PO: Uncertainty-Guided Exploration Control for Stable Multi-Turn Agentic Reinforcement Learning](https://arxiv.org/abs/2605.02178)
...
### [86] [CBV: Clean-label Backdoor Attacks on Vision Language Models via Diffusion Models](https://arxiv.org/abs/2605.02202)
...
### [87] [CoVSpec: Efficient Device-Edge Co-Inference for Vision-Language Models via Speculative Decoding](https://arxiv.org/abs/2605.02218)
...
### [89] [Shadow-Loom: Causal Reasoning over Graphical World Model of Narratives](https://arxiv.org/abs/2605.02475)
*David Wilmot*
...
### [90] [Trustworthy AI Suffers from Invariance Conflicts and Causality is The Solution](https://arxiv.org/abs/2605.02640)
...
### [91] [AcademiClaw: When Students Set Challenges for AI Agents](https://arxiv.org/abs/2605.02661)
...
### [92] [The 2026 ACII Dyadic Conversations (DaiKon) Workshop & Challenge](https://arxiv.org/abs/2605.02672)
...
### [93] [Foundation Models to Unlock Real-World Evidence from Nationwide Medical Claims](https://arxiv.org/abs/2605.02740)
...
### [94] [When Audio-Language Models Fail to Leverage Multimodal Context for Dysarthric Speech Recognition](https://arxiv.org/abs/2605.02782)
...
### [95] [The Topology of Multimodal Fusion: Why Current Architectures Fail at Creative Cognition](https://arxiv.org/abs/2604.04465)
*Xiujiang Tan*
...
### [96] [GAZE: Grounded Agentic Zero-shot Evaluation with Viewer-Level Tools and Literature Retrieval on Rare Brain MRI](https://arxiv.org/abs/2605.00876)
...
### [97] [Interpretable experiential learning based on state history and global feedback](https://arxiv.org/abs/2605.00940)
*Anton Kolonin*
...
### [98] [Physiology-Aware Masked Cross-Modal Reconstruction for Biosignal Representation Learning](https://arxiv.org/abs/2605.00973)
...
### [99] [Learning to Race in Minutes: Infoprop Dyna on the Mini Wheelbot](https://arxiv.org/abs/2605.01096)
...
### [100] [Toward a foundational thermal model for residential buildings](https://arxiv.org/abs/2605.01364)
...
### [101] [Forager: a lightweight testbed for continual learning with partial observability in RL](https://arxiv.org/abs/2605.01131)
...
### [102] [Breaking the Computational Barrier: Provably Efficient Actor-Critic for Low-Rank MDPs](https://arxiv.org/abs/2605.01242)
...
### [103] [S^3-R1: Learning to Retrieve and Answer Step-by-Step with Synthetic Data](https://arxiv.org/abs/2605.01248)
...
### [104] [GA-VisAgent: A Multi-Agent application for code generation and visualization in interactive learning](https://arxiv.org/abs/2605.01299)
...
Matched keywords: behavior cloning, reinforcement learning, policy learning
...
### [107] [Quantifying Multimodal Capabilities: Formal Generalization Guarantees in Pairwise Metric Learning](https://arxiv.org/abs/2605.01424)
...
### [108] [Towards Efficient and Expressive Offline RL via Flow-Anchored Noise-conditioned Q-Learning](https://arxiv.org/abs/2605.01663)
...
Matched keywords: robot, robotic manipulation, manipulation, locomotion, reinforcement learning
...
### [109] [Protein-Conditioned Multi-Objective Reinforcement Learning for Full-Length mRNA Design](https://arxiv.org/abs/2605.01513)
...
### [110] [Training Non-Differentiable Networks via Optimal Transport](https://arxiv.org/abs/2605.01928)
*An T. Le*
...
### [111] [Hybrid Quantum Reinforcement Learning with QAOA for Improved Vehicle Routing Optimization](https://arxiv.org/abs/2605.01574)
...
### [112] [Enhancing RL Generalizability in Robotics through SHAP Analysis of Algorithms and Hyperparameters](https://arxiv.org/abs/2605.02867)
...
### [113] [Geospatial foundation-model embeddings improve population estimation unevenly across space and scale](https://arxiv.org/abs/2605.01650)
...
### [114] [Mitigating Multimodal LLMs Hallucinations via Relevance Propagation at Inference Time](https://arxiv.org/abs/2605.01766)
...
### [115] [Adversarial Imitation Learning with General Function Approximation: Theoretical Analysis and Practical Algorithms](https://arxiv.org/abs/2605.01778)
...
Matched keywords: imitation learning, policy learning
...
### [116] [Selector-Guided Autonomous Curriculum for One-Shot Reinforcement Learning from Verifiable Rewards](https://arxiv.org/abs/2605.01823)
...
### [117] [TRAP: Tail-aware Ranking Attack for World-Model Planning](https://arxiv.org/abs/2605.01950)
...
### [118] [Multi-User Dueling Bandits: A Fair Approach using Nash Social Welfare](https://arxiv.org/abs/2605.01961)
...
### [119] [MER-DG: Modality-Entropy Regularization for Multimodal Domain Generalization](https://arxiv.org/abs/2605.01967)
...
### [120] [AdamO: A Collapse-Suppressed Optimizer for Offline RL](https://arxiv.org/abs/2605.01968)
...
### [121] [RamanBench: A Large-Scale Benchmark for Machine Learning on Raman Spectroscopy](https://arxiv.org/abs/2605.02003)
...
### [122] [Statistical Consistency and Generalization of Contrastive Representation Learning](https://arxiv.org/abs/2605.02116)
...
### [123] [LUMINA: A Grid Foundation Model for Benchmarking AC Optimal Power Flow Surrogate Learning](https://arxiv.org/abs/2605.02133)
...
### [124] [Experience Constrained Hierarchical Federated Reinforcement Learning for Large-scale UAV Teams in Hazardous Environments](https://arxiv.org/abs/2605.02165)
...
### [125] [Break the Block: Dynamic-size Reasoning Blocks for Diffusion Large Language Models via Monotonic Entropy Descent with Reinforcement Learning](https://arxiv.org/abs/2605.02263)
...
### [126] [A Meta Reinforcement Learning Approach to Goals-Based Wealth Management](https://arxiv.org/abs/2605.02300)
...
### [127] [Differentiable Kernel Ridge Regression for Deep Learning Pipelines](https://arxiv.org/abs/2605.02313)
...
### [128] [Binary Rewards and Reinforcement Learning: Fundamental Challenges](https://arxiv.org/abs/2605.02375)
*Marc Dymetman*
...
### [129] [Closed-Loop CO2 Storage Control With History-Based Reinforcement Learning and Latent Model-Based Adaptation](https://arxiv.org/abs/2605.02405)
...
### [130] [Reference-Sampled Boltzmann Projection for KL-Regularized RLVR: Target-Matched Weighted SFT, Finite One-Shot Gaps, and Policy Mirror Descent](https://arxiv.org/abs/2605.02469)
...
### [131] [Efficient Preference Poisoning Attack on Offline RLHF](https://arxiv.org/abs/2605.02495)
...
### [132] [Pretraining on Sleep Data Improves non-Sleep Biosignal Tasks](https://arxiv.org/abs/2605.02500)
...
### [133] [Recurrent Deep Reinforcement Learning for Chemotherapy Control under Partial Observability](https://arxiv.org/abs/2605.02552)
...
### [134] [Gradient-Gated DPO: Stabilizing Preference Optimization in Language Models](https://arxiv.org/abs/2605.02626)
*Inoussa Mouiche*
...
### [135] [Federated Reinforcement Learning for Efficient Mobile Crowdsensing under Incomplete Information](https://arxiv.org/abs/2605.02705)
...
### [136] [Visual Latents Know More Than They Say: Unsilencing Latent Reasoning in MLLMs](https://arxiv.org/abs/2605.02735)
...
### [137] [Bolek: A Multimodal Language Model for Molecular Reasoning](https://arxiv.org/abs/2605.02745)
...
### [138] [A decoupled diffusion planner that adapts to changing cost limits by using cost-conditioned generation for safety and reward gradients for performance](https://arxiv.org/abs/2605.02777)
...
### [139] [Adversarial Flow Matching for Imperceptible Attacks on End-to-End Autonomous Driving](https://arxiv.org/abs/2605.00880)
...
### [140] [LiteVLA-H: Dual-Rate Vision-Language-Action Inference for Onboard Aerial Guidance and Semantic Perception](https://arxiv.org/abs/2605.00884)
...
Matched keywords: manipulation, vision-language-action, vla, multimodal
...
### [141] [Skeleton-Based Posture Classification to Promote Safer Walker-Assisted Gait in Older Adults](https://arxiv.org/abs/2605.00890)
...
### [142] [X2SAM: Any Segmentation in Images and Videos](https://arxiv.org/abs/2605.00891)
...
### [143] [RA-CMF: Region-Adaptive Conditional MeanFlow for CT Image Reconstruction](https://arxiv.org/abs/2605.00901)
...
### [144] [Validation of Whole-Slide Foundation Models for Image Retrieval in TCGA Data](https://arxiv.org/abs/2605.00902)
...
### [145] [Generalized Category Discovery under Domain Shifts: From Vision to Vision-Language Models](https://arxiv.org/abs/2605.00906)
...
### [146] [TRIP-Evaluate: An Open Multimodal Benchmark for Evaluating Large Models in Transportation](https://arxiv.org/abs/2605.00907)
...
### [147] [SAMamba3D: adapting Segment Anything for generalizable 3D segmentation of multiphase pore-scale images](https://arxiv.org/abs/2605.00916)
...
### [148] [WildTableBench: Benchmarking Multimodal Foundation Models on Table Understanding In the Wild](https://arxiv.org/abs/2605.01018)
...
### [149] [EmoMM: Benchmarking and Steering MLLM for Multimodal Emotion Recognition under Conflict and Missingness](https://arxiv.org/abs/2605.01024)
...
### [150] [ScribbleEdit: Synthetic Data for Image Editing with Scribbles and Text](https://arxiv.org/abs/2605.01135)
...
### [151] [Semantic Context-aware mOdality fUsion Transformer (SCOUT): A Context-Aware Multimodal Transformer for Concept-Grounded Pathology Report Generation](https://arxiv.org/abs/2605.01144)
...
### [152] [CEZSAR: A Contrastive Embedding Method for Zero-Shot Action Recognition](https://arxiv.org/abs/2605.01165)
...
### [153] [CADFit: Precise Mesh-to-CAD Program Generation with Hybrid Optimization](https://arxiv.org/abs/2605.01171)
...
### [154] [Asymmetric Invertible Threat: Learning Reversible Privacy Defense for Face Recognition](https://arxiv.org/abs/2605.01217)
...
### [155] [TT4D: A Pipeline and Dataset for Table Tennis 4D Reconstruction From Monocular Videos](https://arxiv.org/abs/2605.01234)
...
Matched keywords: robot, robot learning, multimodal
...
### [156] [CUE: Concept-Aware Multi-Label Expansion to Mitigate Concept Confusion in Long-Tailed Learning](https://arxiv.org/abs/2605.01309)
...
### [157] [Beyond Perceptual Shortcuts: Causal-Inspired Debiasing Optimization for Generalizable Video Reasoning in Lightweight MLLMs](https://arxiv.org/abs/2605.01324)
...
### [158] [Rethinking Model Selection in VLM Through the Lens of Gromov-Wasserstein Distance](https://arxiv.org/abs/2605.01325)
...
### [159] [VoxAfford: Multi-Scale Voxel-Token Fusion for Open-Vocabulary 3D Affordance Detection](https://arxiv.org/abs/2605.01365)
...
Matched keywords: robot, multimodal, affordance
...
### [160] [IMPACT-HOI: Supervisory Control for Onset-Anchored Partial HOI Event Construction](https://arxiv.org/abs/2605.01666)
...
### [161] [Hybrid Visual Telemetry for Bandwidth-Constrained Robotic Vision: A Pilot Study with HEVC Base Video and JPEG ROI Stills](https://arxiv.org/abs/2605.01826)
...
### [162] [AttnRouter: Per-Category Attention Routing for Training-Free Image Editing on MMDiT](https://arxiv.org/abs/2605.01480)
...
### [163] [Research on Vision-Language Question Answering Models for Industrial Robots](https://arxiv.org/abs/2605.01483)
...
### [164] [EdgeLPR: On the Deep Neural Network trade-off between Precision and Performance in LiDAR Place Recognition](https://arxiv.org/abs/2605.02275)
...
### [165] [Hyp2Former: Hierarchy-Aware Hyperbolic Embeddings for Open-Set Panoptic Segmentation](https://arxiv.org/abs/2605.02580)
...
### [166] [SF20K Competition 2025: Summary and findings](https://arxiv.org/abs/2605.01496)
...
### [167] [Seeing Realism from Simulation: Efficient Video Transfer for Vision-Language-Action Data Augmentation](https://arxiv.org/abs/2605.02757)
...
### [168] [Towards Visual Query Localization in the 3D World](https://arxiv.org/abs/2605.01498)
...
### [169] [Two-Pass Zero-Shot Temporal-Spatial Grounding of Rare Traffic Events in Surveillance Video](https://arxiv.org/abs/2605.01512)
*Jiantang Huang*
...
### [170] [MIRL: Mutual Information-Guided Reinforcement Learning for Vision-Language Models](https://arxiv.org/abs/2605.01520)
...
### [171] [Omni-Fake: Benchmarking Unified Multimodal Social Media Deepfake Detection](https://arxiv.org/abs/2605.01638)
...
### [172] [Act2See: Emergent Active Visual Perception for Video Reasoning](https://arxiv.org/abs/2605.01657)
...
### [173] [TRIMMER: A New Paradigm for Video Summarization through Self-Supervised Reinforcement Learning](https://arxiv.org/abs/2605.01659)
...
### [174] [Video Active Perception: Effective Inference-Time Long-Form Video Understanding with Vision-Language Models](https://arxiv.org/abs/2605.01662)
...
### [175] [IMPACT-Scribe: Interactive Temporal Action Segmentation with Boundary Scribbles and Query Planning](https://arxiv.org/abs/2605.01668)
...
### [176] [TrajRAG: Retrieving Geometric-Semantic Experience for Zero-Shot Object Navigation](https://arxiv.org/abs/2605.01700)
...
### [177] [Multi-Scale Gaussian-Language Map for Zero-shot Embodied Navigation and Reasoning](https://arxiv.org/abs/2605.01736)
...
### [178] [Embody4D: A Generalist 4D World Model for Embodied AI](https://arxiv.org/abs/2605.01799)
...
### [179] [Referring Multiple Regions with Large Multimodal Models via Contextual Latent Steering](https://arxiv.org/abs/2605.01827)
...
### [180] [GeoSAE: Geometric Prior-Guided Layer-Wise Sparse Autoencoder Annotation of Brain MRI Foundation Models](https://arxiv.org/abs/2605.01829)
...
### [181] [BadmintonGRF: A Multimodal Dataset and Benchmark for Markerless Ground Reaction Force Estimation in Badminton](https://arxiv.org/abs/2605.01876)
...
### [182] [Chart-FR1: Visual Focus-Driven Fine-Grained Reasoning on Dense Charts](https://arxiv.org/abs/2605.01882)
...
### [183] [Divide and Conquer: Decoupled Representation Alignment for Multimodal World Models](https://arxiv.org/abs/2605.01896)
...
Matched keywords: multimodal, world model, foundation model
...
### [184] [WindowQuant: Mixed-Precision KV Cache Quantization based on Window-Level Similarity for VLMs Inference Optimization](https://arxiv.org/abs/2605.02262)
...
### [185] [CADFS: A Big CAD Program Dataset and Framework for Computer-Aided Design with Large Language Models](https://arxiv.org/abs/2605.01925)
...
### [186] [Ultrasound Vision-Language Alignment via Contrastive Learning](https://arxiv.org/abs/2605.02126)
...
### [187] [From Where Things Are to What They Are For: Benchmarking Spatial-Functional Intelligence in Multimodal LLMs](https://arxiv.org/abs/2605.02130)
...
### [188] [Video Generation with Predictive Latents](https://arxiv.org/abs/2605.02134)
...
### [189] [MultiSense-Pneumo: A Multimodal Learning Framework for Pneumonia Screening in Resource-Constrained Settings](https://arxiv.org/abs/2605.02207)
...
### [190] [InfiltrNet: Dual-Branch CNN-Transformer Architecture for Brain Tumor Infiltration Risk Prediction](https://arxiv.org/abs/2605.02230)
...
### [191] [Fine-Tuning Impairs the Balancedness of Foundation Models in Long-tailed Personalized Federated Learning](https://arxiv.org/abs/2605.02247)
...
### [192] [SpectraDINO: Bridging the Spectral Gap in Vision Foundation Models via Lightweight Adapters](https://arxiv.org/abs/2605.02258)
...
### [193] [Rethinking Electro-Optical Vision Foundation Models for Remote Sensing Retrieval: A Controlled Comparison with Generalist VFM](https://arxiv.org/abs/2605.02283)
...
### [194] [A Hybrid Approach for Closing the Sim2real Appearance Gap in Game Engine Synthetic Datasets](https://arxiv.org/abs/2605.02291)
*Stefanos Pasios*
...
### [195] [Channel-Level Relation to Attentive Aggregation with Neighborhood-Homogeneity Constraint for Point Cloud Analysis](https://arxiv.org/abs/2605.02357)
...
### [196] [Enhancing Multimodal In-Context Learning via Inductive-Deductive Reasoning](https://arxiv.org/abs/2605.02378)
...
### [197] [FEAT: Fashion Editing and Try-On from Any Design](https://arxiv.org/abs/2605.02393)
...
### [198] [Stylistic Attribute Control in Latent Diffusion Models](https://arxiv.org/abs/2605.02583)
...
### [199] [Representation learning from OCT images](https://arxiv.org/abs/2605.02589)
...
### [200] [Validation of an AI-based end-to-end model for prostate pathology using long-term archived routine samples](https://arxiv.org/abs/2605.02614)
...
### [201] [Global-Local Feature Decoding with Adapter-Guided SAMv2 for Salient Object Detection](https://arxiv.org/abs/2605.02616)
...
### [202] [Retrieving Any Relevant Moments: Benchmark and Models for Generalized Moment Retrieval](https://arxiv.org/abs/2605.02623)
...
### [203] [AutoFocus: Uncertainty-Aware Active Visual Search for GUI Grounding](https://arxiv.org/abs/2605.02630)
...
### [204] [ViewSAM: Learning View-aware Cross-modal Semantics for Weakly Supervised Cross-view Referring Multi-Object Tracking](https://arxiv.org/abs/2605.02638)
...
### [205] [Mamoda2.5: Enhancing Unified Multimodal Model with DiT-MoE](https://arxiv.org/abs/2605.02641)
...
### [206] [OphMAE: Bridging Volumetric and Planar Imaging with a Foundation Model for Adaptive Ophthalmological Diagnosis](https://arxiv.org/abs/2605.02714)
...
### [207] [Perceptual Flow Network for Visually Grounded Reasoning](https://arxiv.org/abs/2605.02730)
...
### [208] [Virtual Scanning for NSCLC Histology: Investigating the Discriminatory Power of Synthetic PET](https://arxiv.org/abs/2605.02746)
...
### [209] [Teaching LLMs Brazilian Healthcare: Injecting Knowledge from Official Clinical Guidelines](https://arxiv.org/abs/2605.01077)
...
### [210] [OralMLLM-Bench: Evaluating Cognitive Capabilities of Multimodal Large Language Models in Dental Practice](https://arxiv.org/abs/2605.01333)
...
### [211] [A Multi-View Media Profiling Suite: Resources, Evaluation, and Analysis](https://arxiv.org/abs/2605.01336)
...
### [212] [LLM Output Detectability and Task Performance Can be Jointly Optimized](https://arxiv.org/abs/2605.01350)
...
### [213] [Injecting Distributional Awareness into MLLMs via Reinforcement Learning for Deep Imbalanced Regression](https://arxiv.org/abs/2605.01402)
...
### [214] [Medmarks: A Comprehensive Open-Source LLM Benchmark Suite for Medical Tasks](https://arxiv.org/abs/2605.01417)
...
### [215] [The Compliance Gap: Why AI Systems Promise to Follow Process Instructions but Don't](https://arxiv.org/abs/2605.01771)
*Kwan Soo Shin*
...
### [216] [RMGAP: Benchmarking the Generalization of Reward Models across Diverse Preferences](https://arxiv.org/abs/2605.01831)
...
### [217] [Spatiotemporal Hidden-State Dynamics as a Signature of Internal Reasoning in Large Language Models](https://arxiv.org/abs/2605.01853)
...
### [218] [Enhancing Judgment Document Generation via Agentic Legal Information Collection and Rubric-Guided Optimization](https://arxiv.org/abs/2605.02011)
...
### [219] [A Multimodal Dataset for Visually Grounded Ambiguity in Machine Translation](https://arxiv.org/abs/2605.02035)
...
### [221] [Compositional Multi-hop Factual Error Correction via Decomposition-and-Injection](https://arxiv.org/abs/2605.02277)
...
### [222] [PC-MNet: Dual-Level Congruity Modeling for Multimodal Sarcasm Detection via Polarity-Modulated Attention](https://arxiv.org/abs/2605.02447)
...
### [224] [Coordination Architecture Shapes Continuous Demand Response Outcomes in Building Districts](https://arxiv.org/abs/2605.01362)
...
### [225] [Quasi-Static Control of Discrete Cosserat Rod](https://arxiv.org/abs/2605.01395)
*Srishti Siddharth*
...
### [226] [Point-to-Cloud NMPC with Smooth Avoidance Constraints](https://arxiv.org/abs/2605.01431)
...
### [227] [Physics Driven Digital Twin Model for Evaluation of GNSS User Receiver Equipment](https://arxiv.org/abs/2605.01553)
...
### [228] [Zero-Shot, Safe and Time-Efficient UAV Navigation via Potential-Based Reward Shaping, Control Lyapunov and Barrier Functions](https://arxiv.org/abs/2605.01787)
...
### [229] [Stability of Control Lyapunov Function Guided Reinforcement Learning](https://arxiv.org/abs/2605.01978)
...
### [230] [Observability Conditions and Filter Design for Visual Pose Estimation via Dual Quaternions](https://arxiv.org/abs/2605.02054)
...
### [231] [Differentially Private Synthetic Voltage Phasor Release for Distribution Grids](https://arxiv.org/abs/2605.02390)
